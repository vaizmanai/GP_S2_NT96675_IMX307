...
//	{  GPIO_LCD_BLG_PCTL,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST	}, // high active
	...
	{  GPIO_WIFI_CS,		    GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST	}, // high active
	...
	//TV
	//{  GPIO_TV_PLUG,		GPIO_DIR_OUTPUT,		GPIO_SET_OUTPUT_LOW,		PAD_TV_PLUG	},
	{  GPIO_TV_PLUG,		GPIO_DIR_INPUT,		PAD_PULLUP,		PAD_TV_PLUG	},
	//LED1
	
	{  GPIO_LED1_CTL,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,		PAD_LED1_CTL		},
	//amplifier
