...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
...
#elif (defined(_SENSOR1_CMOS_IMX307M_) && defined(_SENSOR2_CMOS_IMX225P_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK },
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_12BITS},
    {
        PIN_FUNC_MIPI_LVDS,
        PIN_MIPI_LVDS_CFG_CLK0 |
        PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3
...
#elif (defined(_SENSOR1_CMOS_TP2825_) ||defined(_SENSOR2_CMOS_TP2825_)||defined(_SENSOR1_CMOS_TP2852_)||defined(_SENSOR2_CMOS_TP2852_) )
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_CCIR8BITS | PIN_SENSOR_CFG_MCLK},
   ...
   // {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3},
...
#elif (defined(_SENSOR1_CMOS_N4_) && defined(_SENSOR2_CMOS_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_SPCLK_2ND},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {
        PIN_FUNC_MIPI_LVDS,
        PIN_MIPI_LVDS_CFG_CLK0 |
	...
	PIN_I2C_CFG_CH1 |
#endif
#if(defined(_SENSOR1_CMOS_IMX307M_) && defined(_SENSOR2_CMOS_IMX225P_))
    ...
    PIN_I2C_CFG_CH2 |
#endif
#if (defined(_SENSOR1_CMOS_TP2825_) || defined(_SENSOR2_CMOS_TP2825_)||defined(_SENSOR1_CMOS_TP2852_) ||defined(_SENSOR2_CMOS_TP2852_))
    PIN_I2C_CFG_CH1 |
#endif
#if (defined(_SENSOR1_CMOS_N4_) && defined(_SENSOR2_CMOS_OFF_))
	PIN_I2C_CFG_CH3 |
#endif
		0
	},
	...
	//
//	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_THROUGH}, // for ILI9342C
	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_PARALL565}, // for ILI9342C
