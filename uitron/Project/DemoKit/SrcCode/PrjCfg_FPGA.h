#ifndef _PRJCFG_FPGA_H_
#define _PRJCFG_FPGA_H_
#include "Type.h"
#include "SysKer.h"

#define IPCAM_MD_FUNC DISABLE//ENABLE
#define IPCAM_VQA_FUNC 			ENABLE
//==============================================================================
//   MODE and Major Feature (Maintain these in \Kernel, \System, \Mode folder)
//==============================================================================
#define IPCAM_DEMO                      DISABLE     //sa4 add

//Custom product config selection
#define IPCAM_2MP						1
#define IPCAM_5MP						2
#define IPCAM_PRODUCT                   IPCAM_2MP
...
#define POWERON_FAST_BOOT               ENABLE  //sa4 update
...
///////FD param
#define IPCAM_FD_FUNC DISABLE    //is conflict with _FD_FUNC_ and MOVIE_FD_FUNC_
#define MAX_FDNUM     10        //set face detection max face number
//////DIS param
//#define IPCAM_DIS_FUNC DISABLE       // is conflict with MOVIE_DIS
