...
// movie size table
MOVIE_SIZE_ITEM g_MovieSizeTable[] = {
	...
	[MOVIE_SIZE_1920x1080P60] = {
		{1920, 1080, 60, 3700 * 1024, MEDIAREC_DAR_DEFAULT, IMAGERATIO_16_9},
		{1, 2, 36, 6, -6, 0},
		{1, 4, 60, 3700 * 1024, 15, 26, 10, 50, 26, 10, 40, 0, 1, 8, 4},
	},

	[MOVIE_SIZE_1920x1080P30] = {
		{1920, 1080, 30, 1850 * 1024, MEDIAREC_DAR_DEFAULT, IMAGERATIO_16_9},
		{1, 2, 36, 6, -6, 0},
		{1, 4, 30, 1850 * 1024, 15, 26, 10, 50, 26, 10, 40, 0, 1, 8, 4},
	},
...
//MOVIE_SIZE_TAG
MOVIE_REC_ITEM g_MovieRecSizeTable[MOVIE_SIZE_ID_MAX] = {
...
[MOVIE_SIZE_FRONT_2880x2160P50] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 50, 1024 * 1024, 5, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_3840x2160P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 1024 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_2880x2160P24] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 24, 1024 * 1024, 12, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},

[MOVIE_SIZE_FRONT_2704x2032P60] = {
	MOVIE_REC_TYPE_FRONT,
	{2704, 2032, 60, 5200 * 1024, MEDIAREC_DAR_DEFAULT, IMAGERATIO_4_3},
	{0},
	{1, 2, 36, 6, -6,	0},
	{0},
	{1, 4, 60, 5200 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_2560x1440P80] = {
	...
	{1, 2, 36, 6, -6,	0},
	{0},
	{1, 4, 80, 4650 * 1024, 20, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_2560x1440P60] = {
	...
	{1, 2, 36, 6, -6,	0},
	{0},
	{1, 4, 60, 3500 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1920x1080P120] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 120, 1024 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1920x1080P96] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 96, 1024 * 1024, 12, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1920x1080P60] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 60, 1024 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
#else
[MOVIE_SIZE_FRONT_2880x2160P50] = {
	MOVIE_REC_TYPE_FRONT,
	{2880, 2160, 50, 4900 * 1024, MEDIAREC_DAR_16_9, IMAGERATIO_16_9},
	{0},
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 50, 4900 * 1024, 25, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_3840x2160P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 3900 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_2880x2160P24] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 24, 2350 * 1024, 12, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_2560x1440P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 1750 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_2304x1296P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 1400 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1920x1080P120] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 120, 3900 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1920x1080P96] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 96, 3150 * 1024, 12, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1920x1080P60] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 60, 3700 * 1024, 15, 26, 10, 50, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
#endif
...
[MOVIE_SIZE_FRONT_1920x1080P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 1850*1024, 15, 26, 10, 50, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1280x720P240] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 240, 3500 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1280x720P120] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 120, 1750 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1280x720P60] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 60,	850 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_1280x720P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 450 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_848x480P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 200 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_640x480P240] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 240, 1150 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_640x480P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 150 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_FRONT_320x240P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{0},
	{1, 4, 30, 50 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{0},
},
...
[MOVIE_SIZE_DUAL_1920x1080P30_1920x1080P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{1, 2, 36, 6, -6, 0},
	{1, 4, 30, 1000 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{1, 4, 30, 1000 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
},
...
[MOVIE_SIZE_CLONE_1920x1080P60_848x480P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{1, 2, 36, 6, -6, 0},
	{1, 4, 60, 1950 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{1, 4, 30, 200 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
},
...
[MOVIE_SIZE_CLONE_2048x2048P30_480x480P30] = {
	...
	{1, 2, 36, 6, -6, 0},
	{1, 2, 36, 6, -6, 0},
	{1, 4, 30, 2000 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
	{1, 4, 30, 100 * 1024, 15, 26, 10, 40, 26, 10, 40, 0, 1, 4, 2},
},
