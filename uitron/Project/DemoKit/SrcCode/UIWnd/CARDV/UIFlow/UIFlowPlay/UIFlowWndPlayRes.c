...
SHOW_ITEM_GROUP(CMD_Group,Normal74,47,5,74,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Protect,0,49,5,76,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal94,189,207,242,234)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,189,207,242,234)
...
SHOW_ITEM_GROUP(CMD_Group,Normal98,71,207,124,234)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,71,207,124,234)
...
SHOW_ITEM_GROUP(CMD_Group,Normal107,130,207,183,234)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,130,207,183,234)
