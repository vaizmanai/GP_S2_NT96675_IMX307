...
extern VControl UIFlowWndMovie_StaticICN_ProtectCtrl;//Status type 

typedef enum
{
UIFlowWndMovie_StaticICN_Protect_ICON_LOCK,
UIFlowWndMovie_StaticICN_Protect_MAX
}UIFlowWndMovie_StaticICN_Protect_Setting;
