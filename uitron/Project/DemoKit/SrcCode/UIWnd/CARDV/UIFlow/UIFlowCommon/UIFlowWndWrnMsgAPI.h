...
typedef enum
{
    ...
    FLOWWRNMSG_ISSUE_NOTFAT32 = STRID_MEMORYNOTFAT32,
    ...
    FLOWWRNMSG_ISSUE_NO_FAT32 = STRID_MEMORYNOTFAT32,
...
#define UIFlowWndWrnMsg_StatusTXT_Msg_STRID_NOTFAT32        FLOWWRNMSG_ISSUE_NOTFAT32
