...
CTRL_LIST_ITEM(UIMenuWndUSB_TabBar)
CTRL_LIST_END
...
//---------------------UIMenuWndUSB_TabBarCtrl Control List---------------------------
CTRL_LIST_BEGIN(UIMenuWndUSB_TabBar)
CTRL_LIST_END

//----------------------UIMenuWndUSB_TabBarCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndUSB_TabBar)
EVENT_END
