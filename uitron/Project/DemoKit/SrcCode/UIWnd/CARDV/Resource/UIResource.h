...
#define ICON_VOL_3                  ICONID_NULL_TMP
#define ICON_VOL_4                  ICONID_NULL_TMP
#define ICON_VOL_5                  ICONID_NULL_TMP
#define ICON_VOL_6                  ICONID_NULL_TMP
#define ICON_VOL_7                  ICONID_NULL_TMP
#define ICON_VOL_8                  ICONID_NULL_TMP
#endif
...
enum _STRID_USER_
{
    ...
    STRID_ISO6400,
    STRID_ISO12800,
    STRID_FRONT_2880x2160P24, //UHD P24
    STRID_FRONT_2560x1440P30, //QHD P30
    STRID_FRONT_2304x1296P30, //3MHD P30
    STRID_FRONT_1920x1080P96, //FHD
    STRID_FRONT_1920x1080P60, //FHD
    STRID_FRONT_1920x1080P30, //FHD
    STRID_FRONT_1280x720P120, //HD
    STRID_FRONT_1280x720P60, //HD
    STRID_FRONT_1280x720P30,  //HD
    STRID_FRONT_848x480P30,   //WVGA
    STRID_FRONT_640x480P240,   //VGA
    STRID_FRONT_640x480P30,   //VGA
    STRID_FRONT_320x240P30,   //QVGA
