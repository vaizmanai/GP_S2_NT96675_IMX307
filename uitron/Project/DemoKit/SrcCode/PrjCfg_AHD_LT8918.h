...
#define FW_VERSION_NUM                  "Q09-2_V02_20180611"
...
#define POWERON_FAST_RECORD             ENABLE
...
#if 0 //(defined(_SENSOR1_CMOS_IMX291M_) && defined(_SENSOR2_CMOS_OFF_))
...
#else //#elif (defined(_SENSOR1_CMOS_IMX291M_) && defined(_SENSOR2_CMOS_TP2825_))
...
#define OSD_USE_DOUBLE_BUFFER           ENABLE //use double buffer
     ...
     defined(_Disp_IFPA_LCD1_T397P04_)||\
     defined(_Disp_IF8B_LCD1_ILI9342_))
...
// VDO size and format
#if 0 // defined(_Disp_IFPA_LCD1_T397P04_)
#define DISPLAY_VDO_W                 864
...
#elif (defined(_Disp_IF8B_LCD1_AUCN01_) || defined(_Disp_IF8B_LCD1_TXDT270C_8961_6A6_R2_))
#define LCDMODE                         DISP_LCDMODE_RGBD320 //DISP_LCDMODE_YUV640
#elif defined(_Disp_IF8B_LCD1_TXDT270C_8961_6A6_)
#define LCDMODE                         DISP_LCDMODE_RGBD320//DISP_LCDMODE_RGBD320//DISP_LCDMODE_RGB_SERIAL //DISP_LCDMODE_YUV640
...
#define LCDMODE                        DISP_LCDMODE_RGB_PARALL565 //  DISP_LCDMODE_RGB_THROUGH
...
#define DUALCAM_PIP_BEHIND_FLIP         ENABLE //Flip 2nd cam image in PIP view. Need extra 1/2 VDO buffer
#define IMG_FULL_DISP					ENABLE //image display in whole device but keep aspect ratio (crop image for display if necessary)
...
#define FILEDB_CARDV_ROOT               "YICarCam"   // the max length should not exceeds 16
// DCF Config
...
#define GSENSOR_FUNCTION               DISABLE //  ENABLE//DISABLE  //G-sensor
#define GPS_FUNCTION                            ENABLE //DISABLE

#define ASR_REC_FUNCTION                  DISABLE //   ENABLE//DISABLE  // lyg
...
#define VIDEO_WIFI_MERGER               ENABLE
...
#define THUMB_STAMP_FUNC				ENABLE
...
#define STOP_REC_BK  ENABLE
#define NMEDIAPLAY_FUNC                 ENABLE     // switch SMediaPlay and NMediaPlay flow, use NMediaPlay when ENABLE to be set.


#define YOUQING_COMMON_CHANGE ENABLE
#define DRIVER_REPORT_FUNC  DISABLE

#define YOUQING_USB_UNPLUG_POWER_OFF ENABLE

//pgl 20180529 add beg
#define YQ_CONFIG_SET_DEFAULT_DATETIME ENABLE
...
#define YQ_CONFIG_SYNC_DATETIME_AUTO ENABLE
...
//----------add---------------------
#define _GPS_MODULE_ID_WRITE_      ENABLE
#define _Compatibility_ShangCheng_APP_ ENABLE
#define _GPS_SPEED_MOVIE_STAMP_ ENABLE
#define WIFI_ON_OFF DISABLE
#define CRASH_FUNCTION	DISABLE
#define _AHD_1080P_  ENABLE
#if (_AHD_1080P_==ENABLE)
#define EXIF_MODEL_NAME                 "96675" //  "NT5800"
#else
#define EXIF_MODEL_NAME                 "96675"
#endif
#define WIFI_MULTICHANNEL    DISABLE
#define Capacitance_version   DISABLE
#define ADAS_OFF_MENU    ENABLE
#define  LONG_STARTUP  DISABLE
#define MOVIE_CYCLICREC_OFF_MENU    ENABLE


//============================
#define Client_ZX             0
#define Client_TeiGeRong   1

#define Client_Name   Client_ZX
//============================
