...
#define LCDMODE                         DISP_LCDMODE_RGB_SERIAL//DISP_LCDMODE_RGBD320//DISP_LCDMODE_RGB_SERIAL //DISP_LCDMODE_YUV640
...
#define MOVIE_UVAC_FUNC					DISABLE // enable UVAC function in movie mode
