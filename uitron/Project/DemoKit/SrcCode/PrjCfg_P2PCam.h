#ifndef _PRJCFG_P2PCAM_H_
#define _PRJCFG_P2PCAM_H_
#include "Type.h"
#include "SysKer.h"

#define CFG_ECOS_IPCAM
...
#define IPCAM_MAIN_SUB_BUFFER_ONE    4 //(for MAIN-DISP-SUB1, its required buffer count= 1-1-1.)
	...
	#define IPCAM_SUB1_WIDTH         848//640
	#define IPCAM_SUB1_HEIGHT        480
	...
	//buffer
	#define IPCAM_BUFFER_LEVEL       IPCAM_BUFFER_ONE
...
#define IPCAM_VDOENC_MAX_BUF_MS   		1500    //length of encoder output buffer
#define IPCAM_VDOENC_RESERVED_BUF_MS 	1000    //reserved length of encoder output buffer
...
#define IPCAM_AUD_IN_MAX_BUF_CNT		50		//unit: 100ms
...
#define POWERON_FAST_BOOT               ENABLE //not used any more
#define POWERON_FAST_BOOT_WITH_MSG      ENABLE //not used any more
...
// for fast sensor, the first sensor mode must be known by user.
// if you dont know it, please disable it
#define POWERON_FAST_SENSOR             ENABLE //require POWERON_FAST_BOOT ENABLE, for quick set 1st sensor mode
#define POWERON_FAST_SENSOR_MODE        SENSOR_MODE_1 //require POWERON_FAST_SENSOR
...
#define PTY_FUNC                        DISABLE  // persudo uitron pty
...
#define IPCAM_DEFOG_FUNC			DISABLE //defog function
#define IPCAM_LCE_FUNC 				DISABLE //Local Contrast Enhancement
...
#else
#define UCTRL_FUNC                      ENABLE//DISABLE
#endif
