...
#if 1//((!defined(_SENSOR1_CMOS_OFF_)) && (!defined(_SENSOR2_CMOS_OFF_)))
...
// VDO size and format
#define DISPLAY_VDO_W                  320 //  640  lyg
#define DISPLAY_VDO_H                   240 // 480
#define DISPLAY_VDO_FMT                 DISP_PXLFMT_YUV422_PK

#define VDO_USE_DOUBLE_BUFFER         ENABLE // DISABLE //use double buffer
...
#define VDO_USE_PHOTO_SOURCE            ENABLE  //display photo video streaming
     ...
     defined(_Disp_IFPA_LCD1_ST7789V2_)|| \
     defined(_Disp_IF8B_LCD1_ILI9342_))
#define VDO_ROTATE_DIR                  ISF_VDO_DIR_ROTATE_90
...
#define LCDMODE                         DISP_LCDMODE_RGB_SERIAL
      ...
      defined(_Disp_IF8B_LCD1_S2002L11_ST7789S_)
...
// DCF Config
#define USE_DCF                         DISABLE // ENABLE    //  lyg
...
#define GSENSOR_FUNCTION                ENABLE//DISABLE  //G-sensor
...
#define MOVIE_UVAC_FUNC                 ENABLE//DISABLE
...
#define _AUTOVP_FUNC_                 DISABLE //  ENABLE
...
#define GXGFX_ADVANCED_STRING_FUNC  DISABLE //ENABLE  JPEG icon  lyg
...
//----------add---------------------
#define PHOTO_MODE_CAP_YUV420_FUNC      ENABLE  // 672 lyg
#define     NT675_NT672   DISABLE   // if is 675 ENABLE  lyg


#define _GPS_MODULE_ID_WRITE_ ENABLE
#define _Compatibility_ShangCheng_APP_ ENABLE
#define _GPS_SPEED_MOVIE_STAMP_ ENABLE
#define WIFI_ON_OFF   DISABLE // ENABLE
#define CRASH_FUNCTION	ENABLE
#define _AHD_1080P_  DISABLE
#if (_AHD_1080P_==ENABLE)
#define EXIF_MODEL_NAME                 "NT5800"
#else
#define EXIF_MODEL_NAME                 "96672"
#endif
