...
extern const WATERLOGO_BUFFER g_WaterLogoCap;
#endif
...
extern void     MovieStamp_UpdateData_Thumb(UINT32 vid, UINT16 uiFlag);
...
extern ER MovieStamp_VsUpdateOsd(UINT32 uiVidEncId, UINT32 enable, UINT32 id,  UINT32 layer, UINT32 region, UINT32 uiX, UINT32 uiY, UINT32 uiOSDWidth, UINT32 uiOSDHeight, void *picture);
...
extern void MovieStamp_DrawMultiStamp(UINT32 uiVidEncId, UINT32 CntId, UPOINT *Pos, char *pStr);
#endif
#endif
