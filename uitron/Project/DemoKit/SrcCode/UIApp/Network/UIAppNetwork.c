...
char gSSID[NVT_WSC_MAX_SSID_LEN] = "GP-S2 v1.01";
char gSSID_AP_default[NVT_WSC_MAX_SSID_LEN] = "GP-S2 v1.01";
char gPASSPHRASE[NVT_MAX_WEP_KEY_LEN] = "0123456789";
char gPASSPHRASE_AP_default[NVT_MAX_WEP_KEY_LEN] = "0123456789";
...
void UINet_WifiSettings(nvt_wifi_settings *pwifi, UINT32 mode, UINT32 security)
{
	...
	if (mode == NET_AP_MODE || mode == NET_WPS_AP_PBC_MODE) {
		...
		if (ptMenuStoreInfo->strSSID[0] == 0) {
			...
			snprintf(pwifi->ssid, NVT_WSC_MAX_SSID_LEN, "%s %02x%02x", gSSID, gMacAddr[4], gMacAddr[5]);//yxf_debug 20191114		 
#else
