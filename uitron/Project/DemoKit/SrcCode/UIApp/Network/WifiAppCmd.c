...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_AUDIO, NVTEVT_WIFI_EXE_MOVIE_AUDIO, 0, 0, FL_MOVIE_AUDIO_WIFI)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_KEY, 0, (UINT32)XML_SRK, 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_MJPEG_RTSP,   0, (UINT32)XML_Movie_Liveview, 0, FL_MJPEG_RTSP)
