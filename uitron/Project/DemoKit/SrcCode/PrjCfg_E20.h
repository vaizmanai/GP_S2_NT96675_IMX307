#ifndef _PRJCFG_G600_H_
#define _PRJCFG_G600_H_
#include "Type.h"
#include "SysKer.h"
...
//..............................................................................
// FW version and name
#define FW_UPDATE_NAME                  "A:\\FW96670A.bin"
...
#define EMPTYPWROFF_FUNCTION            DISABLE //ENABLE
//auto sleep
...
//#define SENSOR_DEFAULT_DISPLAY_MASK     (SENSOR_1|SENSOR_2)
#define SENSOR_DEFAULT_DISPLAY_MASK     (SENSOR_1)
#endif
...
#define DISPLAY_VDO_W                   480
#define DISPLAY_VDO_H                   800
#else
...
#elif defined(_Disp_IFPA_LCD1_T30P106_)
#define LCDMODE                         DISP_LCDMODE_RGB_PARALL565
#else
#error "Unknown _LCD_"
#endif
...
#define EXIF_MAKER_NAME                 "CARDV"
// End string must be '\0', total char must be 31
#define EXIF_MODEL_NAME                 "E20"
// End string must be '\0', total char must be 31
#define EXIF_IMAGE_DESCROPTOIN          "CARDV CAMERA"
...
#define _TSR_FUNC_                      DISABLE//ENABLE
#define MAX_FDNUM                       10
...
#define MOVIE_TSR_FUNC_                 DISABLE//ENABLE
...
#define VIDEOSPRITE_STAMP_FUNC 			DISABLE//ENABLE
#define IME_TMNR_FUNC					ENABLE

#define POWER_KEY_LONG_PRESS			ENABLE

#endif //_PRJCFG_G600_H_
