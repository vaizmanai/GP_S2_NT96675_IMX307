...
#define IPCAM_5MP                    5
#define IPCAM_8MP                    8
#define IPCAM_PRODUCT                IPCAM_2MP  // <-- choose your product here
...
#define IPCAM_MAIN_SUB_BUFFER_ONE    4 //(for MAIN-DISP-SUB1, its required buffer count= 1-1-1.)
                                     //DATA FLOW: ImagePipe is triggered by itself.
                                     //DATA USAGE: NOT protected.
                                     //PRO: need 1 buffer only for each stream.
                                     //CON: support ImagePipe+encode/display steps only, NOT support any other pre-encode process.
	...
	//main: IPCAM_PATH_ID_0
	#define IPCAM_MAIN_ON_OFF        1
	#define IPCAM_MAIN_WIDTH         1920
	#define IPCAM_MAIN_HEIGHT        1080
	//sub1: IPCAM_PATH_ID_2
	#define IPCAM_SUB1_ON_OFF        1
	#define IPCAM_SUB1_WIDTH         832
	#define IPCAM_SUB1_HEIGHT        ALIGN_ROUND_4(IPCAM_SUB1_WIDTH *IPCAM_MAIN_HEIGHT / IPCAM_MAIN_WIDTH)
	//sub2: IPCAM_PATH_ID_3
	#define IPCAM_SUB2_ON_OFF        0	//If enable sub2, 'TV' must be OFF in [ModelConfig_xxx.txt] because they both use the same ime path
	#define IPCAM_SUB2_WIDTH         640
	#define IPCAM_SUB2_HEIGHT        480
	//sub3: IPCAM_PATH_ID_4
	#define IPCAM_SUB3_ON_OFF        0	//If enable sub2/3, 'TV' must be OFF in [ModelConfig_xxx.txt] because they both use the same ime path
	#define IPCAM_SUB3_WIDTH         640
	#define IPCAM_SUB3_HEIGHT        368

	//fps
	#define IPCAM_IN_FPS             30
	#define IPCAM_OUT_FPS            30
	...
	#define	IPCAM_ALG_PATH_NO        -1
	#define IPCAM_YUV_PATH_NO		 -1
	#define	IPCAM_ASPECT_RATIO       {16, 9}


#elif (IPCAM_PRODUCT == IPCAM_3MP)
	//main: IPCAM_PATH_ID_0
	#define IPCAM_MAIN_ON_OFF        1
	#define IPCAM_MAIN_WIDTH         2304
	#define IPCAM_MAIN_HEIGHT        1536
	//sub1: IPCAM_PATH_ID_2
	#define IPCAM_SUB1_ON_OFF        1
	#define IPCAM_SUB1_WIDTH         832
	#define IPCAM_SUB1_HEIGHT        ALIGN_ROUND_4(IPCAM_SUB1_WIDTH *IPCAM_MAIN_HEIGHT / IPCAM_MAIN_WIDTH)
	...
	#define	IPCAM_ALG_PATH_NO        -1
	#define IPCAM_YUV_PATH_NO		 -1
	#define	IPCAM_ASPECT_RATIO       {3, 2}


#elif (IPCAM_PRODUCT == IPCAM_4MP)
	//main: IPCAM_PATH_ID_0
	#define IPCAM_MAIN_ON_OFF        1
	#define IPCAM_MAIN_WIDTH         2592
	#define IPCAM_MAIN_HEIGHT        1520
	//sub1: IPCAM_PATH_ID_2
	#define IPCAM_SUB1_ON_OFF        1
	#define IPCAM_SUB1_WIDTH         1280
	#define IPCAM_SUB1_HEIGHT        ALIGN_ROUND_4(IPCAM_SUB1_WIDTH *IPCAM_MAIN_HEIGHT / IPCAM_MAIN_WIDTH)
	//sub2: IPCAM_PATH_ID_3
	#define IPCAM_SUB2_ON_OFF        0	//If enable sub2, 'TV' must be OFF in [ModelConfig_xxx.txt] because they both use the same ime path
	#define IPCAM_SUB2_WIDTH         640
...
#elif (IPCAM_PRODUCT == IPCAM_5MP)
	//main: IPCAM_PATH_ID_0
	#define IPCAM_MAIN_ON_OFF        1
	#define IPCAM_MAIN_WIDTH         2592
	#define IPCAM_MAIN_HEIGHT        1936
	//sub1: IPCAM_PATH_ID_2
	#define IPCAM_SUB1_ON_OFF        1
	#define IPCAM_SUB1_WIDTH         832
	#define IPCAM_SUB1_HEIGHT        ALIGN_ROUND_4(IPCAM_SUB1_WIDTH *IPCAM_MAIN_HEIGHT / IPCAM_MAIN_WIDTH)
	//sub2: IPCAM_PATH_ID_3
	#define IPCAM_SUB2_ON_OFF        0	//If enable sub2, 'TV' must be OFF in [ModelConfig_xxx.txt] because they both use the same ime path
	#define IPCAM_SUB2_WIDTH         448
	#define IPCAM_SUB2_HEIGHT        320
	//sub3: IPCAM_PATH_ID_4
	#define IPCAM_SUB3_ON_OFF        0	//If enable sub2, 'TV' must be OFF in [ModelConfig_xxx.txt] because they both use the same ime path
	#define IPCAM_SUB3_WIDTH         384
	#define IPCAM_SUB3_HEIGHT        320
	...
	#define	IPCAM_ALG_PATH_NO        -1
	#define IPCAM_YUV_PATH_NO		 -1
	#define	IPCAM_ASPECT_RATIO       {4, 3}


#elif (IPCAM_PRODUCT == IPCAM_8MP)
	//main: IPCAM_PATH_ID_0
	#define IPCAM_MAIN_ON_OFF        1
	#define IPCAM_MAIN_WIDTH         3840
	#define IPCAM_MAIN_HEIGHT        2160
	//sub1: IPCAM_PATH_ID_2
	#define IPCAM_SUB1_ON_OFF        0
	#define IPCAM_SUB1_WIDTH         1280
	#define IPCAM_SUB1_HEIGHT        ALIGN_ROUND_4(IPCAM_SUB1_WIDTH *IPCAM_MAIN_HEIGHT / IPCAM_MAIN_WIDTH)
	//sub2: IPCAM_PATH_ID_3
	#define IPCAM_SUB2_ON_OFF        0	//If enable sub2, 'TV' must be OFF in [ModelConfig_xxx.txt] because they both use the same ime path
...
#if IPCAM_SUB3_ON_OFF==1 && IPCAM_SUB2_ON_OFF==0
	#error (SUB3 stream can not be existed alone, need to turn on SUB2 stream)
#endif


//vout(liveview): IPCAM_PATH_ID_1 (Turn on/off Vout by the variables 'TV' and 'LCD' in [ModelConfig_xxx.txt])
#if defined(_TV_OFF_) && defined(_Disp_VIRTUAL_LCD1_OFF_)
	#define IPCAM_DISP_ON_OFF      0
#else
	#define IPCAM_DISP_ON_OFF      1
#endif
#define IPCAM_DISP_WIDTH         720
#define IPCAM_DISP_HEIGHT        576


#define IPCAM_MAIN_MAX_BYTES     ((IPCAM_MAIN_WIDTH * IPCAM_MAIN_HEIGHT * 2) / 8)
#define IPCAM_SUB1_MAX_BYTES     ((IPCAM_SUB1_WIDTH * IPCAM_SUB1_HEIGHT * 2) / 8)
#define IPCAM_SUB2_MAX_BYTES     ((IPCAM_SUB2_WIDTH * IPCAM_SUB2_HEIGHT * 2) / 8)
#define IPCAM_SUB3_MAX_BYTES     ((IPCAM_SUB3_WIDTH * IPCAM_SUB3_HEIGHT * 2) / 8)

#define SENSOR2						DISABLE

//Secondary Sensor Config: Set the value with the same as primary sesnor's, now.
//                         If sensor2 is different sensor, change the sensor2 value here.
#if SENSOR2
#define SENSOR2_MAIN_ON_OFF        IPCAM_MAIN_ON_OFF
#define SENSOR2_SUB1_ON_OFF        IPCAM_SUB1_ON_OFF
#define SENSOR2_SUB2_ON_OFF        IPCAM_SUB2_ON_OFF
#else
#define SENSOR2_MAIN_ON_OFF        0
#define SENSOR2_SUB1_ON_OFF        0
#define SENSOR2_SUB2_ON_OFF        0
#endif
#define SENSOR2_MAIN_WIDTH         IPCAM_MAIN_WIDTH
#define SENSOR2_MAIN_HEIGHT        IPCAM_MAIN_HEIGHT
#define SENSOR2_SUB1_WIDTH         IPCAM_SUB1_WIDTH
#define SENSOR2_SUB1_HEIGHT        IPCAM_SUB1_HEIGHT
#define SENSOR2_SUB2_WIDTH         IPCAM_SUB2_WIDTH
#define SENSOR2_SUB2_HEIGHT        IPCAM_SUB2_HEIGHT
#define SENSOR2_MAIN_MAX_BYTES     IPCAM_MAIN_MAX_BYTES
#define SENSOR2_SUB1_MAX_BYTES     IPCAM_SUB1_MAX_BYTES
#define SENSOR2_SUB2_MAX_BYTES     IPCAM_SUB2_MAX_BYTES
...
#define IPCAM_AUD_IN_MAX_SAMPLE_RATE	16000	//valid value: 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000
#define IPCAM_AUD_IN_MAX_BIT			16		//valid value: 16
#define IPCAM_AUD_IN_MAX_CHANNELS		2		//valid value: 1, 2
#define IPCAM_AUD_IN_MAX_BUF_CNT		10		//unit: 100ms

#define IPCAM_AUD_OUT_MAX_SAMPLE_RATE	16000	//valid value: 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000
#define IPCAM_AUD_OUT_MAX_BIT			16		//valid value: 16
#define IPCAM_AUD_OUT_MAX_CHANNELS		2		//valid value: 1, 2
#define IPCAM_AUD_OUT_MAX_BUF_CNT		10		//unit: 100ms


//==============================================================================
//   MODE and Major Feature (Maintain these in \Kernel, \System, \Mode folder)
//==============================================================================
#define IPCAM_DEMO                      DISABLE
...
#define POWERON_FAST_BOOT               DISABLE //not used any more
#define POWERON_FAST_CPU2_BOOT          DISABLE //not used any more
...
//..............................................................................
// Storage Config
#define FWS_FUNC                        DISABLE  //enable it, if require load fw for start DSP

#define PST_FUNC                        DISABLE  //enable it, if require write pstore (in Linux side)

#define FS_FUNC                         DISABLE  //enable it, if require write file (in uitron side)
...
//#NT#2016/12/14#Niven Cho -end
	...
	#warning Not enable your device for FWS_FUNC?
	#warning Please assign your "EMBMEM" and "EMBMEM_UITRON" option in "ModelConfig_XXXX.txt"
	#error (see above)
#endif
#endif
#if (PST_FUNC == ENABLE)
#if defined(_EMBMEM_NONE_) || defined(_EMBMEM_UITRON_OFF_)
	#warning Not enable your device for PST_FUNC?
	#warning Please assign your "EMBMEM" and "EMBMEM_UITRON" option in "ModelConfig_XXXX.txt"
	#error (see above)
#endif
#endif
#if (FS_FUNC == ENABLE)
#if defined(_CARD1_NONE_)
	#warning Not enable your device for FS_FUNC?
	#warning Please assign your "CARD1" option in "ModelConfig_XXXX.txt"
	#error (see above)
#endif
#endif
...
#define EMPTYPWROFF_FUNCTION            DISABLE                 //sa4 update
//auto sleep
#define AUTOSLEEP_FUNCTION              DISABLE //Auto Detect   //sa4 update
//auto power-off
#define AUTOPWROFF_FUNCTION             DISABLE //Auto Detect   //sa4 update
...
#define TV_POWER_SAVE_MODE			ENABLE // if no TV insert, close IDE device

#if defined(_Disp_VIRTUAL_LCD1_OFF_)
	#define DISPLAY1_DEFAULT_DISABLE	ENABLE
#endif
...
#define DISPLAY_OSD_FMT                 DISP_PXLFMT_ARGB8888_PK // 256 colors
...
#define PTY_FUNC                        ENABLE  // persudo uitron pty
...
#if defined(_MODEL_IPCAM1_EVB_) || defined(_MODEL_IPCAM2_EVB_) || defined(_MODEL_IPCAM3_EVB_)
...
//==============================================================================
//VIDEO flow control
#define IPCAM_IPL_DIRECT 				ENABLE //ImagePipe Direct Input Mode. (Even ENABLE, IPL may still run DIRECT_MODE off due to >2592 with two stripe)
...
#define IPCAM_SUB1_ONE_BUFFER			DISABLE //2st Encoder Path is running in Single-Buffer-Mode
#define IPCAM_SUB1_TRIGGER				IPCAM_TRIGGER_SRC //2st Encoder Path trigger mode
#define IPCAM_SUB1_WAIT					ENABLE //2st Encoder Path will waiting for EncodeFinish
#define IPCAM_IPL_SMALLFIRST  			DISABLE //ImagePipe Output Order. (ENABLE: order by size from small to large, DISABLE: order by path-id)
#define IPCAM_MAIN_3DNRSHARE			DISABLE //ImagePipe share 1st Encoder Path's buffer as 3DNR buffer
...
#elif (IPCAM_BUFFER_LEVEL == IPCAM_MAIN_SUB_BUFFER_ONE) //buffer count: 1-1-1
...
#define IPCAM_SUB1_ONE_BUFFER			ENABLE //2st Encoder Path is running in Single-Buffer-Mode
#define IPCAM_SUB1_TRIGGER				IPCAM_TRIGGER_SRC //2st Encoder Path trigger mode
#define IPCAM_SUB1_WAIT					DISABLE //2st Encoder Path will waiting for EncodeFinish
#define IPCAM_IPL_SMALLFIRST  			ENABLE //ImagePipe Output Order. (ENABLE: order by size from small to large, DISABLE: order by path-id)
#define IPCAM_MAIN_3DNRSHARE			ENABLE //ImagePipe share 1st Encoder Path's buffer as 3DNR buffer

#endif

//..............................................................................
//VIDEO functions
#define IPCAM_IPL_3DNR 				ENABLE //ImagePipe 3D Noise Reduction
#define IPCAM_ENC_3DNR 				ENABLE //VideoEncoder 3D Noise Reduction
...
#define IPCAM_MD_FUNC					ENABLE //Motion Detection
#define IPCAM_MD_PATH					2 	   //Motion Path, only support 1/2(IME path2/path3)
#define IPCAM_SMARTROI_FUNC        		DISABLE //Smart ROI
#define IPCAM_VQA_FUNC				ENABLE //Video Quality Analysis
#define IPCAM_PD_FUNC					DISABLE //People Detection
#define IPCAM_PD_DRAW_VIDEO			DISABLE // param of IPCAM_PD_FUNC, draw people frame (just for demo!)
#define IPCAM_BC_FUNC					DISABLE //Background Construction
#define IPCAM_BC_DRAW_VIDEO			DISABLE // param of IPCAM_BC_FUNC, draw bc frame (just for demo!)
#define IPCAM_FD_FUNC 				DISABLE //Face Detection (if enable this, the block count of UIAPPIPCAM_BLOCK_BUFFER_INFO of this path, should add 1 to prevent get_blk fail)
...
#define IPCAM_FTG_FUNC				DISABLE	// Face Tracking & grading, nedd enable:IPCAM_FTG_DRAW_VIDEO/IPCAM_DIS_FUNC/FS_FUNC/FWS_FUNC define and CARD1=CARD1_SD/DSP1_TYPE=DSP1_FREERTOS/EMBMEM_UITRON = EMBMEM_UITRON_ON in ModelConfig_XXXX_EVB.txt
#define MAX_FTGNUM     				10      // param of IPCAM_FTG_FUNC, max face number
#define FTG_PATH					2		//set ftg path
#define IPCAM_FTG_DRAW_VIDEO		DISABLE // param of IPCAM_FTG_FUNC, draw face frame (just for demo!)
#define IPCAM_FTG_ROI_DRAW          DISABLE // param of IPCAM_FTG_FUNC, draw ROI rect
#define IPCAM_FTG_SNAPSHOT			DISABLE
#define IPCAM_FTG_FULL_MAX_BUF_SIZE 250*1024
#define IPCAM_FTG_FACE_MAX_BUF_SIZE 100*1024
#define IPCAM_FTG_FULL_YUV_MAX_BUF_SIZE (1920*1088*3/2+2048) //2038 for ipl header


#define IPCAM_ODT_FUNC				DISABLE
#define IPCAM_ODT_DRAW_VIDEO			DISABLE
#define IPCAM_MD_SAMPLE_660_STYLE   	DISABLE/// md sample code for 660 style
#define IPCAM_LONG_TERM_REF_FUNC		DISABLE //(LTR) long term reference interval(0:disable, >=1:enable)
#define IPCAM_WDR_FUNC				ENABLE //Wide Dynamic Range function, include Local Contrast Enhancement
#define IPCAM_SHDR_FUNC				DISABLE //High Dynamic Range function
#define IPCAM_DEFOG_FUNC			ENABLE //defog function
#define IPCAM_LCE_FUNC 				ENABLE //Local Contrast Enhancement
#define IPCAM_VA_FUNC				ENABLE
...
#else
#define IPCAM_AUDIO_IN_FUNC			DISABLE //Audio Input
#define IPCAM_AUDIO_OUT_FUNC 			DISABLE //Audio Output
#endif
//..............................................................................
//AUDIO functions
#if (AUDIO_FUNC == ENABLE)
...
#else
#define IPCAM_AEC_FUNC  				DISABLE //Audio Echo Cancellation
#define IPCAM_ANR_FUNC  				DISABLE //Audio Noise Reduction
#endif
#define AUDIO_FUNC_PCM                  ENABLE  //PCM
#define AUDIO_FUNC_AAC                  DISABLE //AAC
...
#define IPCAM_AUDSRC_TARGET             32000
#endif

//..............................................................................
//MISC functions
// use ini to replace the config of g_UIAppIPCamEncodeConfig via uctrl
// remember use 'ini_to_uctrl umovieini /umovie.ini' at S15_NvtAppInit
