...
#define FW_VERSION_NUM                  "WH-950-7232_20190215"
#define _WATCH_DOG_FUNC_                ENABLE//DISABLE//
...
#define RTSP_AUDIO_ENABLE DISABLE//ENABLE
#define AUDIO_CMD_UCTRL_ENABLE DISABLE//ENABLE
