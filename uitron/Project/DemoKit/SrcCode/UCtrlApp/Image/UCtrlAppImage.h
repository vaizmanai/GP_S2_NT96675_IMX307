...
typedef enum _ISP_SHDR {
        ISP_SHDR_OFF = 0,       ///<- Linear in SHDR Mode, show long expo frame only
        ISP_SHDR_ON,            ///<- Staggered Mode
        ISP_SHDR_BACKLIGHT,     ///<- (TBD) Back light in SHDR Mode
        ISP_SHDR_ANTIEXPO,              ///<- (TBD) Anti over exposure in SHDR Mode
        ISP_SHDR_MAX_CNT,
        ENUM_DUMMY4WORD(ISP_SHDR)
} ISP_SHDR;
