...
/**
     ...
     @param[in] uitron_addr   Uitron starting address.
     @param[in] uitron_size   Uitron size.
     @return
         - @b E_OK:   success
         - @b E_SYS:  addr or size wrong.
*/
extern ER OS_Init(UINT32 addr, UINT32 size, UINT32 uitron_addr, UINT32 uitron_size);
/**
...
extern void OS_EnterHalt(void);

extern BOOL OS_IsHalt(void);
