...
#define COLOR_RGB555_GET_B(c)       ((CVALUE)(((c) & 0x0000001f) >> 0) << 3) ///< get B channel value of RGB555 color
#define COLOR_RGB555_GET_G(c)       ((CVALUE)(((c) & 0x000003e0) >> 5) << 3) ///< get G channel value of RGB555 color
#define COLOR_RGB555_GET_R(c)       ((CVALUE)(((c) & 0x00007c00) >> 10) << 3) ///< get R channel value of RGB555 color

#define COLOR_RGB444_GET_B(c)       ((CVALUE)(((c) & 0x0000000f) >> 0) << 4) ///< get B channel value of RGB444 color
#define COLOR_RGB444_GET_G(c)       ((CVALUE)(((c) & 0x000000f0) >> 4) << 4) ///< get G channel value of RGB444 color
#define COLOR_RGB444_GET_R(c)       ((CVALUE)(((c) & 0x00000f00) >> 8) << 4) ///< get R channel value of RGB444 color
