...
typedef struct _H265ENC_INIT_ {
	...
	UINT32          uiRotate;           // rotate option : 0 : no rotate , 1 : counterclockwise rotate , 2 : clockwise rotate //0, 90, -90
	...
	UINT32          uiSVCFlag;          ///< H.265 SVC encode SEI header, 0 : disable 1:enable
	UINT32          uiPFrmNum;          ///< H.264 P frame number in one Gop
	INT32           iQPTH;              ///< H.265 Rate Control's QP change Threshold
	UINT8           ucBQP;              ///< H.265 Rate Control's Init BQP
	UINT32          uiBFrmNum;          ///< H.265 B frame number in one Gop : not support in NT96680
	INT32           iRcMaxQp;           ///< H.265 Rate Control's max QP => I and P frame shall be independace, replace to use uiMaxIQp and uiMaxPQp
	INT32           iRcMinQp;           ///< H.265 Rate Control's min QP => I and P frame shall be independace, replace to use uiMinIQp and uiMinPQp
	UINT32          uiIPWeight;         ///< H.265 Rate Control's Init I_WEIGHT and P_WEIGHT (ex: I_WEIGHT=8,P_WEIGHT=2 => uiIPWeight = 0x00080002)
#endif
...
typedef struct _H265ENC_INFO_ {
	...
	UINT32      uiSrcCompressEn;                ///< source compression luma enable
	UINT32      uiSrcCompressChromaEn;          ///< source compression chroma enable
	H26XEncSrcDecomp *pSrcCompressInfo;         ///< src compression info  //510 remove
...
extern INT32 h265Enc_setRoiPlusCfg(H265ENC_VAR *pH265EncVar, UINT32 uiIdx, const H26XEncCu16 *pCu16Attr);
extern INT32 h265Enc_getRoiPlusCfg(H265ENC_VAR *pH265EncVar, UINT32 uiIdx, H26XEncCu16 *pCu16Attr);
...
extern INT32 h265Enc_setRcQPMap(H265ENC_VAR *pH265EncVar, UINT32 uiEnable, UINT8 *QP_MAP, CU16_QP_MODE qp_mode);
extern INT32 h265Enc_getRcQPMap(H265ENC_VAR *pH265EncVar, UINT32 *uiEnable, UINT8 *QP_MAP, CU16_QP_MODE *qp_mode);
...
// others //
extern INT32 h265Enc_setTnrCfg(H265ENC_VAR *pH265EncVar, const H26XEncTnr *pTnrAttr);
extern INT32 h265Enc_getTnrCfg(H265ENC_VAR *pH265EncVar, H26XEncTnr *pTnrAttr);
extern INT32 h265Enc_setFroCfg(H265ENC_VAR *pH265EncVar, const H26XEncFro *pFroAttr);
extern INT32 h265Enc_getFroCfg(H265ENC_VAR *pH265EncVar, H26XEncFro *pFroAttr);
extern INT32 h265Enc_setVarCfg(H265ENC_VAR *pH265EncVar, const H26XEncVarCfg *pVarAttr);
extern INT32 h265Enc_getVarCfg(H265ENC_VAR *pH265EncVar, H26XEncVarCfg *pVarAttr);
extern INT32 h265Enc_setRdnCfg(H265ENC_VAR *pH265EncVar, const H26XEncRdn *pRndAttr);
extern INT32 h265Enc_getRdnCfg(H265ENC_VAR *pH265EncVar, H26XEncRdn *pRndAttr);
extern INT32 h265Enc_setLpmCfg(H265ENC_VAR *pH265EncVar, const H26XEncLPM *pLpmAttr);
extern INT32 h265Enc_getLpmCfg(H265ENC_VAR *pH265EncVar, H26XEncLPM *pLpmAttr);
extern INT32 h265Enc_setMDInfo(H265ENC_VAR *pH265EncVar, const H26XEncMDInfo *pMDInfo);
extern INT32 h265Enc_setMDMap(H265ENC_VAR *pH265EncVar, const void *pMDAttr);
