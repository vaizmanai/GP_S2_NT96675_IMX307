...
typedef struct _H264ENC_INIT_ {
	...
	UINT32          uiRowRcQpDelta;     ///< H.264 Rate Control's row level rate control QP-delta
	...
	// NT96510 //
	INT32          iChromaQpIdx;      /// <.H264 chroma QP index offset
	INT32          iSecChromaQPIdx;   /// <.H264 second chroma QP index offset
...
extern INT32 h264Enc_setRoiPlusCfg(H264ENC_VAR *pH264EncVar, UINT32 uiIdx, const H26XEncCu16 *pCu16Attr);
extern INT32 h264Enc_getRoiPlusCfg(H264ENC_VAR *pH264EncVar, UINT32 uiIdx, H26XEncCu16 *pCu16Attr);
...
extern INT32 h264Enc_setRcQPMap(H264ENC_VAR *pH264EncVar, UINT32 uiEnable, UINT8 *QP_MAP, CU16_QP_MODE qp_mode);
extern INT32 h264Enc_getRcQPMap(H264ENC_VAR *pH264EncVar, UINT32 *uiEnable, UINT8 *QP_MAP, CU16_QP_MODE *qp_mode);
...
extern INT32 h264Enc_setRdoCfg(H264ENC_VAR *pH264EncVar, const H26XEncRdo *pRdoAttr);
extern INT32 h264Enc_getRdoCfg(H264ENC_VAR *pH264EncVar, H26XEncRdo *pRdoAttr);
extern INT32 h264Enc_setVarCfg(H264ENC_VAR *pH264EncVar, const H26XEncVarCfg *pVarAttr);
extern INT32 h264Enc_getVarCfg(H264ENC_VAR *pH264EncVar, H26XEncVarCfg *pVarAttr);
extern INT32 h264Enc_setRdnCfg(H264ENC_VAR *pH264EncVar, const H26XEncRdn *pRndAttr);
extern INT32 h264Enc_getRdnCfg(H264ENC_VAR *pH264EncVar, H26XEncRdn *pRndAttr);
extern INT32 h264Enc_setLpmCfg(H264ENC_VAR *pH264EncVar, const H26XEncLPM *pLpmAttr);
extern INT32 h264Enc_getLpmCfg(H264ENC_VAR *pH264EncVar, H26XEncLPM *pLpmAttr);
extern INT32 h264Enc_setMDInfo(H264ENC_VAR *pH264EncVar, const H26XEncMDInfo *pMDInfo);
extern INT32 h264Enc_setMDMap(H264ENC_VAR *pH264EncVar, const void *pMDAttr);
