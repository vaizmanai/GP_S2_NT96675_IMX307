...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER Jpg_DecOneJPGEx(UJPG_ID JpgID, PJPG_DEC_INFO pDecJPG);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER Jpg_ASyncDecOpenEx(UJPG_ID JpgID);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER Jpg_ASyncDecStartEx(UJPG_ID JpgID, PJPG_DEC_INFO pDecJPG);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER Jpg_ASyncDecWaitDoneEx(UJPG_ID JpgID);
...
/**
    ...
    @return
        ...
        - @b ER_SYS:  Failed.
*/
extern ER Jpg_ASyncDecCloseEx(UJPG_ID JpgID);

//--------------------------------------------------------------------------
// Backward Compatible
//--------------------------------------------------------------------------
#define Jpg_DecOneJPG(pDecJPG)		Jpg_DecOneJPGEx(UJPG_ID_0, pDecJPG)
#define Jpg_ASyncDecOpen() 			Jpg_ASyncDecOpenEx(UJPG_ID_0)
#define Jpg_ASyncDecStart(pDecJPG)  Jpg_ASyncDecStartEx(UJPG_ID_0, pDecJPG)
#define Jpg_ASyncDecWaitDone() 		Jpg_ASyncDecWaitDoneEx(UJPG_ID_0)
#define Jpg_ASyncDecClose() 		Jpg_ASyncDecCloseEx(UJPG_ID_0)
