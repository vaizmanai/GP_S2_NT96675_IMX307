...
GXVID_ER GxVideoFile_Decrypto(UINT32 addr, UINT32 size, UINT8 *key8);

GXVID_ER GxVideoFile_IsDecrypto(BOOL *bDecrypt);

GXVID_ER GxVideoFile_GetDecryptoKey(UINT8 *key);
