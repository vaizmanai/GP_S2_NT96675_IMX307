...
#define MEDIAREADLIB_SETINFO_H26X_WORKBUF  10 ///< param1:src mem range(in)
//@}
...
typedef struct {
	...
	UINT32 audFrmNum; ///< [out] audio total frame number
	...
	BOOL   bStillVdoPid; ///< [out] parse 1st video fail, read more file data size
	//#NT#2013/10/18#Calvin Chang -end
} MEDIA_FIRST_INFO;
