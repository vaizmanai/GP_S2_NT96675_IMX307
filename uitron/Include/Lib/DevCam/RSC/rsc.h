...
typedef struct {
	...
	RSC_DCE_2DLUT_SCALE TwoDLutScaleFact;   ///< 2D lut x y scale factor
} RSC_DCE_2DLUT_PARAM;
...
#define RSC_DBG_OPT_GD_OFS_LOCK                0x2
#define RSC_DBG_OPT_AT_EIS                     0x4

#define RSC_DBG_OPT_CALG_UP                   0x10
#define RSC_DBG_OPT_CALG_DOWN                 0x20
#define RSC_DBG_OPT_CALFG_UP                  0x40
#define RSC_DBG_OPT_CALFG_DOWN                0x80

#define RSC_DBG_OPT_PRINT_PRC_FRM            0x100
#define RSC_DBG_OPT_PRINT_AR                 0x200
#define RSC_DBG_OPT_PRINT_IDX                0x400
#define RSC_DBG_OPT_PRINT_OPEN               0x800
#define RSC_DBG_OPT_PRINT_AT                0x1000
#define RSC_DBG_OPT_PRINT_GD                0x2000
#define RSC_DBG_OPT_PRINT_LT                0x4000
#define RSC_DBG_OPT_PRINT_CRP               0x8000

#define RSC_DBG_OPT_MA_GDC_OFF             0x10000
#define RSC_DBG_OPT_MA_REGDC_OFF           0x20000
#define RSC_DBG_OPT_AR_LOCK                0x40000
#define RSC_DBG_OPT_LT_NEUTRAL             0x80000

#define RSC_DBG_OPT_DELAY_UP               0x100000
#define RSC_DBG_OPT_DELAY_DOWN             0x200000

#define RSC_DBG_OPT_LT_LOCK_SWITCH         0x400000

#define RSC_DBG_OPT_PRINT_LT_TWO        0//(      0x20)
#define RSC_DBG_OPT_TAPE_ASSIGN         0//(     0x100)
#define RSC_DBG_OPT_TAPE_RECORD         0//(     0x200)
#define RSC_DBG_OPT_TAPE_DUMP           0//(     0x400)
#define RSC_DBG_OPT_AT_LOCK_X           0//(   0x10000)
#define RSC_DBG_OPT_AT_LOCK_Y           0//(   0x20000)
#define RSC_DBG_OPT_AT_LOCK_Z           0//(   0x40000)
#define RSC_DBG_OPT_LT_LOCK             0//(  0x100000)
#define RSC_DBG_OPT_LT_LOCK_LEFT        0//(0x80000000)
...
typedef enum {
	...
	RSC_DIR_NEQ = 1,    ///< negative direction, backward-compatible selection for a typo
...
typedef struct {
	...
	UINT32 uiDataUnit;                      ///< Gyro data unit, in degree/65536sec; project-changing; project-related
...
typedef struct {
	UINT32 uiFocalLength;       ///< Focal length for current lens position, in um; frame-changing; frame(UI)-related
} RSC_LENS_SETTING;

typedef struct {
	UINT16 *puiDistortTbl;    ///<    Distortion table pointer of UINT16[32] with RSC_DIST_TBL_UNIT=4096; project-changing; project-related
	UINT32 uiDistortNorm;     ///<    Distortion Table normalization factor  with RSC_DIST_NRM_UNIT=16;   project-changing; project-related
	UINT16 *puiReDistoTbl;    ///< Re-Distortion table pointer of UINT16[32] with RSC_DIST_TBL_UNIT=4096; project-changing; project-related; null for auto-calculation
	UINT32 uiReDistoNorm;     ///< Re-Distortion Table normalization factor  with RSC_DIST_NRM_UNIT=16;   project-changing; project-related;
} RSC_LENS_DISTORT_SETTING;

typedef struct {
	UINT16 uiDistortTbl[RSC_DIST_TBL_NUM];    ///< Distortion table; project-changing; project-related
	UINT16 uiReDistoTbl[RSC_DIST_TBL_NUM];    ///< Distortion table; project-changing; project-related
...
typedef struct {
	...
	BOOL   b2Strp;      ///< Two-Stripe mode enable; just leave it; auto-calculation (while uiIppInSzH>2112)
	UINT32 ui2sOvlpSt;  ///< Two-Stripe overlap Start; just leave it; auto-calculation (always uiIppInSzH/2 - 2880/10)
	UINT32 ui2sOvlpEd;  ///< Two-Stripe overlap End;   just leave it; auto-calculation (always uiIppInSzH/2 + 2880/10)
...
typedef struct {
	UINT32 uiOption;    ///< please refer to "RSC_DBG_OPT_..."
	UINT32 uiData[2];
...
typedef struct {
	...
	INT32 iCalFocalGain;///< the magnitude gain for focal-lenght calibration
} RSC_CAL_SETTING;
...
typedef struct {
	...
	RSC_FLIP_ENG uiEngHandFlip; ///< engine handling flip
} RSC_FLIP_PARAM;
