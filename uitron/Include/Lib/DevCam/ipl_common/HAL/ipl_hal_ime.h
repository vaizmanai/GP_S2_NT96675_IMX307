...
typedef enum _IME_UPDATE {
	...
	IME_OUT_ADDR_REF        = 0x0000000000000020LLU,   ///< update TMNR ref output addr
	...
	IME_OUT_SIZE_REF        = 0x0000000000000800LLU,   ///< update TMNR ref output lineoffset, output size = input size
	...
	IME_PATHEN_REF          = 0x0000000000010000LLU,   ///< update TMNR ref output enable/disable
	...
	IME_HWRST               = 0x0000000000400000LLU,   ///< set hw reset flag to driver, will do reset at ime_open
	...
	IME_YUVCVT              = 0x0000000800000000LLU,   ///< udpate ime yuv converter
	...
	IME_MD_PARAM            = 0x0000080000000000LLU,   ///< update motion detection paramters
	...
	IME_MD_CTRL             = 0x0002000000000000LLU,   ///< udpate motion detection ctrl info
	...
	IME_TMNR_BLOCKINFO      = 0x0200000000000000LLU,   ///< update tmnr block info
	IME_TMNR_IQPARAM        = 0x0400000000000000LLU,   ///< update tmnr IQ parameters
	IME_TMNR_CTRL           = 0x0800000000000000LLU,   ///< update tmnr flow ctrl info
	IME_MD_WIN              = 0x1000000000000000LLU,   ///< update motion detection window info
	IME_MD_EVT_ADDR         = 0x2000000000000000LLU,   ///< update motion detection evt output address
	IME_MD_LV_ADDR          = 0x4000000000000000LLU,   ///< update motion detection lv input address
	IME_DCE_H_STP_INFO      = 0x8000000000000000LLU,   ///< update dce stripe H information for auto select scaling method
} IME_UPDATE;
...
typedef enum _IME_READ {
	...
	IME_R_PATHEN_LIGHT          = 0x0000000E,   ///< read path enable/disable                       Data type: IME_PATHEN_INFO
	...
	IME_R_PATHREFINFO           = 0x00000018,   ///< read path reference size/fmt/crop              Data type: OUTCH
	...
	IME_R_PATHREFADDR           = 0x0000001D,   ///< read path reference output address             Data type: IMEADDR
	...
	IME_R_PATH1_ENCODEEN        = 0x00000022,   ///< read path1 encode enable                       Data type: UINT32
	IME_R_REFOUT_ENCODEEN       = 0x00000023,   ///< read ref out encode enable                     Data type: UINT32
	IME_R_MD_WIN_INFO           = 0x00000024,   ///< read md window info                            Data type: IME_HAL_MD_REGION
	IME_R_TMNR_BLK_INFO         = 0x00000025,   ///< read tmnr block info                           Data type: IME_HAL_STABLK_INFO
	IME_R_TMNR_STAOUT_ADDR      = 0x00000026,   ///< read tmnr sta out address						Data type: UINT32
	IME_R_MD_EVT_ADDR           = 0x00000027,   ///< read md evt out address						Data type: UINT32
	IME_R_SCL_SEL               = 0x00000028,   ///< read ime scale method select					Data type: IME_HAL_SCL_SEL
	IME_R_YUVCVT                = 0x00000029,   ///< read yuv convert info							Data type: IME_HAL_YUVCVT
	IME_R_INPUT_SIZE			= 0x00000030, 	///< read ime input size							Data type: IMESIZE
...
typedef struct _IME_Manager {
	...
	IME_IN IME_In;              ///< ime input information
