...
typedef enum _IFE2_UPDATE {
	...
	IFE2_DRAMOUT_EN         = 0x00000800,       ///< udpate ife2 dramout enable for direct 2 ime mode
	IFE2_HWRST	            = 0x00001000,       ///< set hw reset flag to driver, will do reset at ife2_open
...
typedef struct _IFE2_Manager {
	...
	BOOL             dramout_en;        ///< ife2 dram output when direct to IME mode
