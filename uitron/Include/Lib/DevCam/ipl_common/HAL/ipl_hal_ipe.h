...
typedef enum _IPH_IPE_QUE {
	IPE_REG_VA_INDEP_RST    = 0x00000001,   ///< read VA independent window result          Data type: IPE_HAL_INDEP_VA_WIN_RSLT
	IPE_REG_VARST           = 0x00000002,   ///< read VA result                             Data type: IPE_VARST
	IPE_REG_VARST_MANUAL    = 0x00000003,   ///< read VA result                             Data type: IPE_VARST
...
typedef enum _IPE_UPDATE {
	...
	IPE_VA_INFO         = 0x08000000,   ///< update ipe va information
	IPE_VA_OUTSELECT    = 0x10000000,   ///< update ipe va output selection(group1, group1+2)
	IPE_VA_WINDOW       = 0x20000000,   ///< update ipe va window information
	IPE_HWRST	        = 0x40000000,   ///< set hw reset flag to driver, will do reset at ipe_open
...
typedef enum _IPE_READ {
	...
	IPE_R_VA_PARAM  = 0X00000015,   ///< read va parameter                              Data type: IPE_VA_DramRst
	IPE_R_VA_INDEP	= 0X00000016,	///< read va independent window info				Data type: IPE_HAL_INDEP_VA_PARAM[5]
...
typedef struct _IPE_Manager {
	...
	UINT32 OutLofsVa;           ///< out VA lineoffset
	IPEFmt OutFmt;             ///< out format
	UINT32 OutAddr[3];         ///< out addr (Image: idx0 = y/eth, idx1 = uv/eth_subsample, idx2 = va)
