...
typedef enum _SIE_UPDATE {
	...
	SIE_CH3_ACT2            =   0x0000000002000000LLU,   ///< update ch3 active window 2 output
	SIE_HWRST               =   0x0000000004000000LLU,	 ///< set hw reset flag to driver, will do reset at sie_open
	//                      =   0x0000000008000000LLU
	//                      =   0x0000000010000000LLU,
	SIE_STATS_VIG           =   0x0000000020000000LLU,   ///< statisitc path VIG eng: SIE12
	SIE_STATS_CA_SIZE       =   0x0000000040000000LLU,   ///< statistic CA window size eng: SIE12
	SIE_STATS_LA_SIZE       =   0x0000000080000000LLU,   ///< statistic LA window size eng: SIE12
	SIE_STATS_LA_CG         =   0x0000000100000000LLU,   ///< statistic LA color gain eng: SIE12
	SIE_STATS_LA_GAMMA      =   0x0000000200000000LLU,   ///< statistic LA gamma eng: SIE12
	SIE_STATS_LA_           =   0x0000000400000000LLU,   ///< statistic LA information SIE12
	SIE_STATS_LA_IRSUB      =   0x0000000800000000LLU,   ///< statistic LA IRSUB SIE12
	//                      =   0x0000001000000000LLU
	//                      =   0x0000002000000000LLU
	SIE_STATS_CA_IRSUB      =   0x0000004000000000LLU,   ///< update  statisitc CA IRSUB eng: SIE12
	SIE_STATS_CA_           =   0x0000008000000000LLU,   ///< update statistic CA threshold eng: SIE12
...
typedef enum _SIE_READ {
	...
	SIE_R_BS_OUT_LITE   = 0x00000022,   ///< read sie bayer scale out size only                 Data type: SIE_WIN_INFO         eng: SIE1, SIE2
...
typedef struct _SIE_Manager {
	IPP_SIE_SIGNAL  Sie_Signal; ///< sensor information                         @SIE1/SIE2
	SIE_ACT_MODE ActMode;       ///< sie source selection                       @SIE1/SIE2
	SIE_WINDOW SensorIn_Win;    ///< act/crop wiondow                           @SIE1/SIE2
	SIE_WIN_INFO BSOutImg;      ///< Sie bs output size
	BAYER_TYPE Bayer_Type;      ///< bayer format
	BOOL dir2rhe;               ///< direct to rhe                              @SIE1

	struct {
		SIE_Dma_In In;              ///< bayer in for ActMode = SIE_IN_DRAM     @SIE1
		SIE_WIN_INFO DramIn_Win;    ///< Sie input source image size.           @SIE1/SIE2
	} RAW_IN;

	struct {
		SIE_Dma_Out Out;            ///< -                                      @SIE1/SIE2
		SIE_PACKBUS Bit;            ///< pack bit
		UINT32      ring_buf_len;   ///< ring buffer length(disable if 0)
