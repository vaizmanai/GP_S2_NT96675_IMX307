...
extern void NVTAFALG_SetAfInfoPtr(UINT32 id, AF_SUB_INFO *paf_sub_info, IPL_SET_VA_DATA *pva_info);
...
extern void NVTAFALG_InitVa(UINT32 id);
extern void NVTAFALG_GetVaSta(UINT32 id);
