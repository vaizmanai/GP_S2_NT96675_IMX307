...
/**
     Configure DMA/CPU and some Engine speed for direct mode used

     User needs to implement this function at ChipCfg.c.
     TRUE:  direct mode
     FALSE: normal mode
*/
void DxSys_Cfg_DirectMode(BOOL state);
...
#define CFG_JPEG2_CLK 6 ///< jpeg2 clock
#define CFG_FDE_CLK   7 ///< fde clock
#define CFG_H26X_CLK  8 ///< h26x clock
#define CFG_RHE_CLK   9 ///< rhe clock
#define CFG_IFE_CLK   10 ///< ife clock
#define CFG_IFE2_CLK  11 ///< ife2 clock
#define CFG_IPE_CLK   12 ///< ipe clock
#define CFG_DCE_CLK   13 ///< dce clock
#define CFG_CRYPTO_CLK 14 ///< crypto clock
#define CFG_TSE_CLK	  15  ///< tse clock
