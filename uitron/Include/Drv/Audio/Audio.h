/**
    ...
    for Audio module. The NT96510's audio module is full-duplex capable and allow to transmit
...
/**
    ...
    This definition is used in aud_getTransceiveObject() to get the selected audio Transmit or
...
/**
    ...
    For Embedded codec, only AUDIO_RECSRC_MIC/AUDIO_RECSRC_DMIC are valid.
    Default is AUDIO_RECSRC_MIC.

    @note For AUDIO_SETTING, and aud_setRecordSource()
*/
typedef enum {
	AUDIO_RECSRC_MIC,           ///< Analog Microphone (Default)
	AUDIO_RECSRC_DMIC,          ///< Digital Microphone (Valid for NT96510)

	AUDIO_RECSRC_CD,            ///< CD In (Not Valid for NT96510)
	AUDIO_RECSRC_VIDEO,         ///< Video In (Not Valid for NT96510)
	AUDIO_RECSRC_AUX,           ///< Aux In (Not Valid for NT96510)
	AUDIO_RECSRC_LINE,          ///< Line In (Not Valid for NT96510)
	AUDIO_RECSRC_STEREO_MIX,    ///< Stereo Mix (Not Valid for NT96510)
	AUDIO_RECSRC_MONO_MIX,      ///< Mono Mix (Not Valid for NT96510)
	AUDIO_RECSRC_PHONE,         ///< Phone In (Not Valid for NT96510)
...
/**
    ...
    Use "aud_setI2SChBits(AUDIO_I2SCH_BITS)" to specify how many bits per audio TDM I2S channel.
*/
typedef enum {
...
/**
    ...
    The api aud_switchCodec(AUDIO_CODECSEL) is used to switch audio-codec(internal or external) and the HDMI-audio.
...
/**
    ...
    If aud_setTotalVolLevel() is set to  AUDIO_VOL_LEVEL8,  the AUDIO_VOL_MUTE/AUDIO_VOL_0 ~ AUDIO_VOL_7  are valid.
    If aud_setTotalVolLevel() is set to  AUDIO_VOL_LEVEL64, the AUDIO_VOL_MUTE/AUDIO_VOL_0 ~ AUDIO_VOL_63 are valid.
...
/**
    ...
    @note For aud_setTotalRecordGainLevel()
*/
typedef enum {
	AUDIO_RECG_LEVEL8  =  8,            ///< total  8 recordgain level
	AUDIO_RECG_LEVEL16 = 16,            ///< total 20 recordgain level

	ENUM_DUMMY4WORD(AUDIO_RECG_LEVEL)
} AUDIO_RECG_LEVEL;
...
typedef enum {
	...
	AUDIO_GAIN_0,               ///< Gain 0. (ALC target level to -27.0/-28.5 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_1,               ///< Gain 1. (ALC target level to -24.0/-27.0 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_2,               ///< Gain 2. (ALC target level to -21.0/-25.5 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16) (Default)
	AUDIO_GAIN_3,               ///< Gain 3. (ALC target level to -18.0/-24.0 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_4,               ///< Gain 4. (ALC target level to -15.0/-22.5 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_5,               ///< Gain 5. (ALC target level to -12.0/-21.0 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_6,               ///< Gain 6. (ALC target level to -9.0 /-19.5 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_7,               ///< Gain 7. (ALC target level to -6.0 /-18.0 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_8,               ///< Gain 8. (ALC target level to -3.0 /-16.5 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_9,               ///< Gain 9. (ALC target level to -1.5 /-15.0 dBFS @ AUDIO_RECG_LEVEL8/AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_10,              ///< Gain 10.(ALC target level to -13.5dBFS @ AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_11,              ///< Gain 11.(ALC target level to -12.0dBFS @ AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_12,              ///< Gain 12.(ALC target level to -10.5dBFS @ AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_13,              ///< Gain 13.(ALC target level to -9.0 dBFS @ AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_14,              ///< Gain 14.(ALC target level to -7.5 dBFS @ AUDIO_RECG_LEVEL16)
	AUDIO_GAIN_15,              ///< Gain 15.(ALC target level to -6.0 dBFS @ AUDIO_RECG_LEVEL16)
	                            ///< ALC off (PGA gain -18.0~24.0 dBFS +6dB each step @AUDIO_RECG_LEVEL8)
                                ///< ALC off (PGA gain -21.0~24.0 dBFS +3dB each step @AUDIO_RECG_LEVEL16)
...
typedef enum {
	...
	*/
	...
	///<   Default is Enabled after aud_setDefaultSettings(AUDIO_DEFSET) invoked.
...
/**
    ...
    This is used in aud_setParameter(AUDIO_PARAMETER_DAGAIN) to assign additional playback Digital Gain.
*/
typedef enum {
...
/**
    ...
    @note For aud_setParameter(AUDIO_PARAMETER_DBG_MSG_LEVEL)
*/
typedef enum {
...
/**
    ...
    @note For aud_setParameter(AUDIO_PARAMETER_IIRCOEF_L / AUDIO_PARAMETER_IIRCOEF_R, PAUDIO_IIRCOEF).
*/
typedef struct {
	FLOAT   fTotalGain;     ///< Total Gain
	FLOAT   fSectionGain;   ///< Section Gain

	FLOAT   fCoefB0;        ///< Filter coefficient B0
	FLOAT   fCoefB1;        ///< Filter coefficient B1
	FLOAT   fCoefB2;        ///< Filter coefficient B2

	FLOAT   fCoefA0;        ///< Filter coefficient A0
	FLOAT   fCoefA1;        ///< Filter coefficient A1
	FLOAT   fCoefA2;        ///< Filter coefficient A2
} AUDIO_IIRCOEF, *PAUDIO_IIRCOEF;

/**
    Audio Default Settings Select

    This is used at aud_setDefaultSettings() to select audio default configurations.
...
typedef enum {
	...
	///< Atk=0.08ms. Dcy=0.16s. NG-Atk=2.88s. NG-Dcy=0.36s. NG-Target=1.
	///< NoiseGate-TH= -40-30=-70dB from MIC input.
	AUDIO_DEFSET_0DB_HP_8K,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
	///< HighPass Filter 3dB is about 200Hz for SR8KHz. Acting as Wind-Noise suppress filter.
	AUDIO_DEFSET_0DB_HP_16K,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
	///< HighPass Filter 3dB is about 200Hz for SR16KHz. Acting as Wind-Noise suppress filter.
	AUDIO_DEFSET_0DB_HP_48K,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
	///< HighPass Filter 3dB is about 200Hz for SR48KHz. Acting as Wind-Noise suppress filter.

	AUDIO_DEFSET_ALCOFF,      ///< Boost Gain 30dB. NoiseGate-Enable. ALC-Range(-9 ~ +13.5dB).
	///< Atk=0.08ms. Dcy=0.16s. NG-Atk=2.88s. NG-Dcy=0.36s. NG-Target=1.
	///< NoiseGate-TH= -40-30=-70dB from MIC input.
	AUDIO_DEFSET_ALCOFF_HP_8K,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
	///< HighPass Filter 3dB is about 200Hz for SR8KHz. Acting as Wind-Noise suppress filter.
	AUDIO_DEFSET_ALCOFF_HP_16K,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
	///< HighPass Filter 3dB is about 200Hz for SR16KHz. Acting as Wind-Noise suppress filter.
	AUDIO_DEFSET_ALCOFF_HP_48K,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
	///< HighPass Filter 3dB is about 200Hz for SR48KHz. Acting as Wind-Noise suppress filter.
...
/**
    ...
    The Audio Transceive Object (AUDTS_OBJ) is got from aud_getTransceiveObject(AUDTS_CH).
...
/**
    ...
    Used for aud_setDeviceObject(), and aud_getDeviceObject().
    Useless for embedded audio codec.
...
extern PAUDTS_OBJ       aud_getTransceiveObject(AUDTS_CH TsCH);
extern ER               aud_setDefaultSettings(AUDIO_DEFSET DefSet);

extern void             aud_switchCodecDynamic(PAUDIO_CODEC_FUNC pAudioCodecFunc,PAUDIO_SETTING pAudio);
extern void             aud_setExtCodec(PAUDIO_CODEC_FUNC pAudioCodecFunc);
extern void             aud_switchCodec(AUDIO_CODECSEL AudioCodec);
extern void             aud_setDeviceObject(PAUDIO_DEVICE_OBJ pDevObj);
...
extern void             aud_setTotalRecordGainLevel(AUDIO_RECG_LEVEL Audio_GainLevel);
extern AUDIO_RECG_LEVEL aud_getTotalGainLevel(void);
...
//  audio i2s exporting APIs
extern void             aud_setI2SChBits(AUDIO_I2SCH_BITS ChBits);
