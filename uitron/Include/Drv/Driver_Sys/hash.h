...
typedef enum
{
    ...
    HASH_CLOCK_PLL13,                ///< Select HASH clock rate PLL13(for IPP/H265)
...
typedef enum
{
    HASH_CONFIG_ID_CLOCK_RATE,          ///< Select HASH engine internal clock rate usage
                                        ...
                                        ///< - @b HASH_CLOCK_80MHz:      Internal clock rate 80MHz
                                        ///< - @b HASH_CLOCK_160MHz:     Internal clock rate 160MHz
                                        ///< - @b HASH_CLOCK_240MHz:     Internal clock rate 160MHz
...
extern void hash_pio_enable(UINT8* ucInput, UINT32 len);
