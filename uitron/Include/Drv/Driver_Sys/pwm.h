...
#define PWMID_CCNT0             0x00010000  ///< PWM ID CCNT0
#define PWMID_CCNT1             0x00020000  ///< PWM ID CCNT1
#define PWMID_CCNT2             0x00040000  ///< PWM ID CCNT2
//@}

//2017/02/22
//Tim modified: control register interrupt enable/disable
#define PWM_CPU1_ENABLE   ENABLE  //Enable: CPU1; Disable: CPU2
