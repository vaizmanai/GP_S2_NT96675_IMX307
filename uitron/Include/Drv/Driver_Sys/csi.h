...
typedef enum {
	...
	CSI_CONFIG_ID_DIS_SRC,			///< Set csi disable source. Use CSI_DIS_SRC_FRAME_END/CSI_DIS_SRC_FRAME_END2
									///< Set 0 is FrameEnd 1. Set 1 is FrameEnd 2.
	CSI_CONFIG_ID_AUTO_MANUAL,	    ///< Default is DISABLE. After ENABLED, the INVALID DataType would add to manual mode automatically.
	...
	*/
	...
	CSI_CONFIG_ID_A_SYNC_RST_EN,    //   Useless. Backward compatible usages.
	CSI_CONFIG_ID_CLANE_SWITCH,     //   Useless. Backward compatible usages.
	ENUM_DUMMY4WORD(CSI_CONFIG_ID)
} CSI_CONFIG_ID;
#define CSI_CONFIG_ID_DISABLE_SOURCE CSI_CONFIG_ID_DIS_SRC   ///< for backward compatible.
