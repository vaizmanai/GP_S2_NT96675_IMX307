...
/// Tim 2016/12/13
/// CID register fields of MMC
typedef struct {
	UINT32  uiMMCCIDMid;            // manfacture ID [127:120]
	UINT8   uiMMCCIDCBX;            // Device Type [113:112];  [119:114] :Reserved
	UINT8   uiMMCCIDOID;            // Device OEM or Device Cotent  [111:104]
	UINT8   ucMMCCIDPnm[6];         // product name [103:56]
	UINT8   ucMMCCIDRevision;     // Product revision [55:48]
	UINT32  uiMMCCIDPsn;            // card serial number [47:16]
	UINT8   ucMMCCIDMonth;          // manufacturing date - month [15:12]
	UINT8   ucMMCCIDYear;           // manufacturing date - year [11:8]
...
typedef struct {
    ...
    UINT8   ucDriverStrength;       // [197]: driver strength

	UINT8   ucCardType;                 // [196]: bit0: support 26Mhz, bit1: support 52Mhz,
	//  bit2: DDR-52MHz-1.8/3V IO, bit3:DDR-52MHz-1.2V IO
	//  bit4: SDR-HS200-1.8V IO, bit5: SDR-HS200-1.2V IO
	//  bit6: DDR-HS400-1.8V IO, bit7: DDR-HS400-1.2V IO

	UINT8   ucCSDStructVer;           // [194]: CSD structure version : 2= 4.1~5.1; 1 =MMCA; 0 =MMCA
	UINT8   ucExtCSDRev;               // [192]: EXT CSD revision : 8=MMC V5.1; 7=MMC V5.0; 6 = MMC V4.5/4.51;
	// 5=MMC V4.41; 3= MMC V4.3; 2=MMC V4.2; 1=MMC V4.1; 0=MMC V4.0

	UINT8   uiBootMode_Hs;            // [228]BIT2: Boot mode hs support
	UINT8   uiBootMode_Ddr;          // [228]BIT1: Boot mode ddr support
	UINT8   uiBootMode_Alt;          // [228]BIT0: Boot mode alternative support
	UINT32  uiBootMode_Size;        // [226]: Boot mode size support? (uint: byte)
	UINT8   uiBootMode_Ack;          // [179]BIT6: Boot mode ack pattern support
	UINT8   uiBootMode_ParEn;       // [179]BIT5~4:Boot mode Partition enable
	UINT8   uiBootMode_ParAccess; // [179]BIT3~0: Boot mode partition access
	UINT8   uiBootMode_Speed;       // [177]BIT4~3: Boot mode support mode? single/high-speed/ddr?
	UINT8   uiBootMode_RstBootBusWidth;  //  [177]BIT2:Boot mode reset boot bus?
	UINT8   uiBootMode_BusWidth;   // [177]BIT1~0:Boot mode support bus width?
	UINT8   uiBootMode_ErsGrpDef;  // [175]BIT0: Boot mode erase group defition
