...
typedef enum {
	...
	GRPH_GOP_HRZ_CFLT,                  ///< Horizontal chroma filter. (Not support by NT96660)
	GRPH_GOP_VTC_CFLT,                  ///< Vertical chroma filter. (Not support by NT96660)
//    GRPH_GOP_WARP,                      ///< Image Warping (Not support by NT96660)
	GRPH_GOP_VCOV = 8,                  ///< Video Cover
	ENUM_DUMMY4WORD(GRPH_GOP_MODE)
} GRPH_GOP_MODE;

__attribute__((deprecated)) const static GRPH_GOP_MODE GRPH_GOP_WARP = GRPH_GOP_VCOV - 1;
/*
...
typedef enum {
	...
	///< - Source image: GRPH_IMG_ID_A
	///< - Destination image: GRPH_IMG_ID_C
	GRPH_CMD_ROT_0 = 7,                     ///< Rotate 0 degree
	...
	///< - Format: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V, GRPH_FORMAT_32BITS_ARGB8888_RGB, GRPH_FORMAT_16BITS_ARGB1555_RGB, GRPH_FORMAT_16BITS_ARGB4444_RGB
	...
	///< - (GRPH_ID_1, GRPH_ID_2)
	///< - Format:
	///< - GRPH_ID_1: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V, GRPH_FORMAT_16BITS_RGB565, GRPH_FORMAT_32BITS_ARGB8888_RGB, GRPH_FORMAT_16BITS_ARGB1555_RGB, GRPH_FORMAT_16BITS_ARGB1555_A, GRPH_FORMAT_16BITS_ARGB4444_RGB, GRPH_FORMAT_16BITS_ARGB4444_A
...
__attribute__((deprecated)) const static GRPH_CMD GRPH_CMD_WARP = GRPH_CMD_VCOV - 1;
