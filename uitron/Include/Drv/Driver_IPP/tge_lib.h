...
typedef enum {
	TGE_VDTOSIE2_SRC_VD2 = 0,
	ENUM_DUMMY4WORD(TGE_VDTOSIE2_SEL)
} TGE_VDTOSIE2_SEL;
...
typedef enum {
	...
	TGE_CHG_VD2SIE,                ///< TGE VD to SIE               , please refer to "TGE_VDTOSIE_SEL"
	...
	TGE_CHG_MSHB_EXT_INV,           ///< MshB external-trig inv
...
typedef enum {
	...
	CLKSRC_PXCLK2 = 0, ///< TGE clock source as
	CLKSRC_MCLK,      ///< TGE clock source as
	CLKSRC_MCLK2,     ///< TGE clock source as
} TGE_CLKSRC_SEL;
