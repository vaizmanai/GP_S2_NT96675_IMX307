...
extern UINT32 g_uiSie1ActEndCnt;
...
extern void sie1_setHwReset(BOOL bEnable);
...
extern ER sie1_EnablemeasureTime(void);
extern ER sie1_getmeasureTimeInfo(void);

extern void sie1_getCaWin(SIE_CA_WIN_INFO *pSetting);
extern void sie1_getCaIrSub(SIE_CA_IRSUB_INFO *pCaIrSubInfo);
#if (_EMULATION_ == ENABLE)
extern ER sie1_emu_start(void);//Add by K W Wang for all-direct emulation only
#endif
