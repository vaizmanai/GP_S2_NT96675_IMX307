...
#define __CORE1  1           ///< MIPS core1
#define __CORE2  2           ///< MIPS core2
...
extern NVTIPC_I32   NvtIPC_InternalMsgSnd(NVTIPC_U32 msqid, NVTIPC_SENDTO sendTo, void *pMsg, NVTIPC_U32 msgsz);
