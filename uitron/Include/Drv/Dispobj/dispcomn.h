...
/**
    ...
    The Display Object ID used in disp_getDisplayObject() to get the specified display object.
*/
typedef enum {
	DISP_1,     ///< Display ID 1. In the NT96650, this is used to specify IDE1.
	//DISP_2,     ///< Display ID 2. Removed in NT96510.
...
/**
    ...
    This definition is used as the first operand in the dispLyrCtrl API to specify which of the display layer would be controlled.
*/
typedef enum {
	DISPLAYER_OSD1 = 0x02,                  ///< Select display layer osd 1
	DISPLAYER_OSD2 = 0x04,                  ///< Select display layer osd 2
	...
	DISPLAYER_MASK = 0x3E,                  ///< Valid display layer selection mask
...
/**
    ...
    These definitions are used in the function getDispCap of the display object to get the display object capabilities.
*/
//@{
...
typedef enum {
	...
	DISPLYR_ARGB4444    = 0x00000008,   ///< This display layer suppors Buffer format ARGB4444.
	...
	DISPLYR_ARGB1555    = 0x00000080,   ///< This display layer suppors Buffer format ARGB4444.
...
*/
typedef struct {
	DISP_ABI        DisplayAbi;         ///< This field describes the general abilities of display engine. Please refer to the enumeration type of DISP_ABI.

	DISP_LAYER_ABI  Video1Abi;          ///< This field describes the abilities of VIDEO-1 layer. Please refer to the enumeration type of DISP_LAYER_ABI.
	DISP_LAYER_ABI  Video2Abi;          ///< This field describes the abilities of VIDEO-2 layer. Please refer to the enumeration type of DISP_LAYER_ABI.
	DISP_LAYER_ABI  Osd1Abi;            ///< This field describes the abilities of OSD-1 layer. Please refer to the enumeration type of DISP_LAYER_ABI.
	DISP_LAYER_ABI  Osd2Abi;            ///< This field describes the abilities of OSD-2 layer. Please refer to the enumeration type of DISP_LAYER_ABI.
