...
typedef enum {
	...
	DISPLAYER_OP_SET_OSDSWAP,               ///< Set OSD1 / 2 swap layer(Only valid @ IDE1)
	...
	DISPLAYER_OP_GET_OSDSWAP,               ///< Get OSD1 / 2 swap layer(Only valid @ IDE1)
	...
	union {
		...
		*/
		struct { //DISPDEV_SET_OSD_LAYER_SWAP
			BOOL        bEnOSDSwap;             ///< Enable / Disable osd layer swap
		} SET_OSDSWAP;
