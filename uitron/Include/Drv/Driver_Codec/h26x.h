...
typedef struct _H26X3dnr {
	...
	// 510 //
	UINT32 uiMotionTh;              //0x2e4
	UINT32 uiP2PTh;                 //0x2e8
	UINT32 uiMctfTh;                //0x2ec
	UINT32 uiMctfWeight;            //0x2f0
	UINT32 uiP2PWeight;             //0x2f4
	UINT32 uiP2PCfg_5;              //0x2f8
	UINT32 uiP2PCfg_6;              //0x2fc
} H26X3dnr;
...
typedef struct _H26XPicUnit {
	...
	UINT32 uiSrcDecSideInfoLoffset;//remove
	...
	// 510 //
	UINT32 uiDist_Factor;               //0x26c
	UINT32 uiLPMModeCfg;                //0x2b0
	UINT32 uiRMDTweak;              //0x2bc
	UINT32 uiRndNoiseSeed;              //0x2c0
	UINT32 uiRndNoiseCfg;           //0x2c4
	UINT32 uiVAR_1;                 //0x2c8
	UINT32 uiVAR_2;                 //0x2cc
	UINT32 uiIMEScaleCfg;           //0x2e0
	UINT32 uiAQ_TH[15];             //0x3b0~0x3e8
} H26XPicUnit;
...
typedef struct _H26XRegSet {
	...
	UINT32 uiSrcDecSideInfoAddr;//remove
...
extern void h26x_close_hw_power(void);
...
extern void h26x_doAgain(UINT32 uiIsEnc, UINT32 EC_KTab[9], UINT32 ED_KTab[9]);
...
extern void h26x_getECKTablW(UINT32 EC_Tabl[9]);
...
extern void h26x_getSliceResult(UINT32 SliceNum, UINT32 *SliceLen);
...
extern UINT32 h26x_getImeScale(void);
extern UINT32 h26x_getPicCfg1(void);
extern UINT32 h26x_getAEAD3(void);
extern void h26x_setRecOutput(UINT32 uiVal);
extern UINT32 h26x_getNewSrcCheckSum_Y(void);
extern UINT32 h26x_getNewSrcCheckSum_C(void);
extern UINT32 h26x_getSaoNum(void);
extern UINT32 h26x_getRegData(UINT32 uiOffset);
extern void h26x_getPicSize(UINT32 *uiWidth, UINT32 *uiHeight);
#endif
