...
extern void h264_close_hw_power(void);
...
extern UINT32 h264_get_nal_len(UINT32 uiSel);
...
void avc_enc_hack(UINT32 uiPicNum, UINT32 uiPatNum, UINT32 uiRecEn);
void avc_enc_end_hack(void);
void avc_dec_hack(UINT32 uiPicNum, UINT32 uiPatNum);

void avc_enc_dse(UINT32 ui_vir_sde_side_info_addr, UINT32 kTab[3], UINT32 uiWidth, UINT32 uiHeight, UINT32 uiPatNum, UINT32 uiPicNum);
