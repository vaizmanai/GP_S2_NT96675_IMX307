...
typedef  enum {
	...
	IPCAM_CFG_IPL_MAXBUF = IPCAM_CFG_START,
	IPCAM_CFG_PLUG_RTSP,
	//IPCAM_CFG_CROP,
	//IPCAM_CFG_HDMI_OUT,
	IPCAM_CFG_INIT_FLAG,
	...
	IPCAM_AUDIO_OUT,
	IPCAM_CFG_PLUG_DISP,
	IPCAM_CFG_PLUG_AUDIOIN,
	IPCAM_CFG_PLUG_AUDIOENC,
	IPCAM_CFG_PLUG_AUDIOOUT,
	IPCAM_CFG_PLUG_STREAMRECEIVE,
	IPCAM_CFG_PLUG_AUDIODEC,
	IPCAM_DISP_STATUS,
	IPCAM_CFG_MAX_CMD,
...
typedef enum _MOVIESTAMP_FD_CONFIG{
        moviestamp_fd_draw_flag,
        moviestamp_fd_max,
        ENUM_DUMMY4WORD(MOVIESTAMP_FD_CONFIG)

}MOVIESTAMP_FD_CONFIG;

typedef enum _MOVIESTAMP_FTG_CONFIG{
        moviestamp_ftg_landmark_frq,
        moviestamp_ftg_max,
...
INT32 ImageApp_IPCam_Snapshot(UINT32 PathID ,UINT32 *SnapshotAddr,ISIZE ScaleInfo, BOOL bCompress, UINT32 Sensor);
...
extern void ImageApp_IPCam_SetFDDraw(UINT32 type, UINT32 value);

extern int ImageApp_IPCam_GetFDDraw(UINT32 type);

extern void ImageApp_IPCam_SetFTGSetting(UINT32 type, UINT32 value);

extern int ImageApp_IPCam_GetFTGSetting(UINT32 type);

extern void ImageApp_IPCam_ImagePipe_set_status(UINT32 path, ISF_PORT_STATE status);

extern INT32 ImageApp_IPCam_SnapshotYUV(UINT32 PathID,UINT32 *SnapshotAddr,ISIZE ScaleInfo);
