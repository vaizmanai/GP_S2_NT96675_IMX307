...
extern ER PhotoDispTsk_Open(void);

extern ER PhotoDispTsk_Close(void);

extern void PhotoDispTsk(void);

extern void ImageApp_Photo_DispConfig(UINT32 config_id, UINT32 value);

extern ISF_RV ImageApp_Photo_UpdateImgLinkForDisp(PHOTO_DISP_ID disp_id, UINT32 action, BOOL allow_pull);
...
extern ER ImageApp_Photo_WiFiLinkStart(PHOTO_STRM_ID strm_id);

extern ER ImageApp_Photo_WiFiLinkStop(PHOTO_STRM_ID strm_id);

extern ISF_RV ImageApp_Photo_UpdateImgLinkForStrm(PHOTO_STRM_ID strm_id, UINT32 action, BOOL allow_pull);
...
/**
	Check format free feature.

	This api will check format free feature (TRUE or FALSE)

	@return
		- @b 1      : Format free feature TRUE.
		- @b Others : FALSE.
*/
