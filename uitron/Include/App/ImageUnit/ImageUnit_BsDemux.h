...
typedef enum {
	...
	BSDEMUX_PARAM_TRIG_TSDMX,                             ///< TS only, trigger TS demux
	BSDEMUX_PARAM_FILESIZE,                               ///< TS only, total file size
	BSDEMUX_PARAM_TSDMX_BUFBLK,                           ///< TS only, TS demux buffer block number
	BSDEMUX_PARAM_MAX,
