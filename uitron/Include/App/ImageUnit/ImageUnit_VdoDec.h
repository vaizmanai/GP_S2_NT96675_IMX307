...
typedef enum {
	...
	VDODEC_PARAM_RAW_BLK_NUM,                                            ///< set raw block number
	VDODEC_PARAM_STEP_PLAY,                                              ///< set step play (first time reset queue, push by ImageApp)
	VDODEC_PARAM_MAX,
...
typedef enum {
	...
	ISF_VDODEC_EVENT_VDEC_ERR,               ///< to notify UI layer video decode error!
