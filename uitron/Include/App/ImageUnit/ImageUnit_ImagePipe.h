...
#define IMAGEPIPE_FUNC2_TWORAW			0x00002000 //enable two raw buffer
#if defined(_BSP_NA51023_)
#define IMAGEPIPE_FUNC2_DIRECT			0x00008000 //enable direct input from VdoIn to ImagePipe
...
typedef void (*IPL_CB_FP)(IPL_PROC_ID Id, IPL_CBMSG uiMsgID, void *Data);
