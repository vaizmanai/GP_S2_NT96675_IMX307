...
extern UINT32* iq_get_pathcurve_param(UINT id);
...
extern IQS_TMNR_YCC_COMPRESSION_INFO *iqs_get_ycc_compression_info(void);
extern UINT32 iq_get_qp_value(UINT32 id,UINT32 uiSliceType );
extern void iq_set_qp_value(UINT32 id,UINT32 uiSliceType, UINT32 qp);
