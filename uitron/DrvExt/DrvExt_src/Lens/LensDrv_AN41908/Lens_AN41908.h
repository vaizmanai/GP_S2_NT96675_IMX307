...
#define LENS_DRV_ID                 "nvt-ver1.00"     // *
...
#define NEAR_BOUND                  0        // *
#define INF_BOUND                   1050     // *
#define WIDE_BOUND                  0        // *
#define TELE_BOUND                  920      // *
#define INIT_FOCUS_POS              10       // *
#define INIT_ZOOM_POS               135      // *

#define FOCUS_BACKLASH_CORR         10       // * correction for focus backlash
#define ZOOM_BACKLASH_CORR          10       // * correction for zoom backlash

#if !FZ_PLS_PIN_EXIST
#define FOCUS_PSUM_DELAY            31       // * unit: msec (12*AN41908_PULSE1_STEP_CYCLE/27MHz)*255=28 msec
#define ZOOM_PSUM_DELAY             62       // * unit: msec (12*AN41908_PULSE2_STEP_CYCLE/27MHz)*255=56 msec
#else
...
#define GOHOME_PEAK_PULSE_WIDTH     0xFCFC    // set to 150% (vary with PWMMOD=21) 1.5*21*8
...
extern INT32 AN41908_TransmitCmd(AN41908_CHNEL_NUM chnel, AN41908_CMD_TYPE cmd_type, INT32 cmd_arg1, INT32 cmd_arg2);
