...
static void AN41908_Write2SPI(UINT32 value1, UINT32 value2)
{
    ...
    spi_writePacket(MOTOR_AN41908_SPI_CH, 3, (value1 & 0x00FFFF3F));

    if (value2 != 0) {
        spi_writePacket(MOTOR_AN41908_SPI_CH, 3, (value2 & 0x00FFFF3F));
    }
...
INT32 AN41908_TransmitCmd(AN41908_CHNEL_NUM chnel, AN41908_CMD_TYPE cmd_type, INT32 cmd_arg1, INT32 cmd_arg2)
{
    ...
    UINT32 i, spi_data[2] = { 0 }, wr_idx[2] = { 0 };
    UINT32 *pwr_reg;
    ...
    if (cmd_status != -1) {
        AN41908_Write2SPI(spi_data[0], spi_data[1]);

        pwr_reg[wr_idx[0]] = spi_data[0];

        if ((cmd_type != AN41908_SET_MOTOR_CFG) && (spi_data[1] != 0)) {
...
static INT32 AN41908_MotorInit(MOTOR_SEL motor_sel)
{
    ...
    AN41908_TransmitCmd(pmotor_cfg->eChnelSel, AN41908_SET_MOTOR_STEP, wt_reg, 0);
...
#if FZ_PLS_PIN_EXIST
        dly_value = pmotor_cfg->iDlyTime;
#else
        dly_value = LENS_MAX(pmotor_cfg->iDlyTime * LENS_ABS(step_pos) / pmotor_cfg->iMaxStepSize, 2);
#endif
...
static void motorAN41908_SetSignal(MD_SIGNAL signal, UINT32 on)
{
    ...
    case MD_SIGNAL_STANDBY:    // power on/off motor driver
        ...
        AN41908_Write2SPI((reg_0x0B.Reg << 8) + AN41908_VD_FZ_POLARITY, 0);
        AN41908_Write2SPI((reg_0x24.Reg << 8) + AN41908_PULSE1_MOVE_STEP, 0);
        AN41908_Write2SPI((reg_0x29.Reg << 8) + AN41908_PULSE2_MOVE_STEP, 0);
...
static void AN41908_ZoomSetSpeed(UINT32 speed)
{
    ...
    while ((g_LensMotorInfo.LensMotorConfig[0].iMotorStatus == MOTOR_STATUS_BUSY) || (g_LensMotorInfo.LensMotorConfig[1].iMotorStatus == MOTOR_STATUS_BUSY)) {
        LENS_DELAY_MS(1);
    }

    if (g_LensMotorInfo.LensMotorConfig[1].eChnelSel == AN41908_CHNEL1) {
        if (g_LensMotorInfo.LensMotorConfig[0].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL1, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE1_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[0].iExciteEnable | 0x3000) << 8) | AN41908_PULSE2_MOVE_STEP);
        } else if (g_LensMotorInfo.LensMotorConfig[1].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL1, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE1_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[1].iExciteEnable | 0x3000) << 8) | AN41908_PULSE1_MOVE_STEP);
        } else {
        ...
        if (g_LensMotorInfo.LensMotorConfig[0].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL3, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE2_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[0].iExciteEnable | 0x3000) << 8) | AN41908_PULSE1_MOVE_STEP);
        } else if (g_LensMotorInfo.LensMotorConfig[1].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL3, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE2_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[1].iExciteEnable | 0x3000) << 8) | AN41908_PULSE2_MOVE_STEP);
        } else {
...
static void AN41908_FocusSetSpeed(UINT32 speed)
{
    ...
    if (g_LensMotorInfo.LensMotorConfig[0].eChnelSel == AN41908_CHNEL1) {
        if (g_LensMotorInfo.LensMotorConfig[0].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL1, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE1_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[0].iExciteEnable | 0x3000) << 8) | AN41908_PULSE1_MOVE_STEP);
        } else if (g_LensMotorInfo.LensMotorConfig[1].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL1, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE1_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[1].iExciteEnable | 0x3000) << 8) | AN41908_PULSE2_MOVE_STEP);
        } else {
            AN41908_TransmitCmd(AN41908_CHNEL1, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE1_STEP_CYCLE, 0);
        }        
    } else if (g_LensMotorInfo.LensMotorConfig[0].eChnelSel == AN41908_CHNEL3) {
        if (g_LensMotorInfo.LensMotorConfig[0].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL3, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE2_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[0].iExciteEnable | 0x3000) << 8) | AN41908_PULSE2_MOVE_STEP);
        } else if (g_LensMotorInfo.LensMotorConfig[1].iWorkStatus == MOTOR_STATUS_BUSY) {
            AN41908_TransmitCmd(AN41908_CHNEL3, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE2_STEP_CYCLE, ((g_LensMotorInfo.LensMotorConfig[1].iExciteEnable | 0x3000) << 8) | AN41908_PULSE1_MOVE_STEP);
        } else {
            AN41908_TransmitCmd(AN41908_CHNEL3, AN41908_SET_MOTOR_CFG, (wt_reg << 8) | AN41908_PULSE2_STEP_CYCLE, 0);
        }
    }
...
static void motorAN41908_IrcutSetState(MOTOR_IRCUT_ACT state, UINT32 param)
{
    ...
    AN41908_Write2SPI((reg_0x2C.Reg << 8) + AN41908_IRCUT_CTL, 0);
