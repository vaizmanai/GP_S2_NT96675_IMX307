...
extern UINT32 _SECTION(".kercfg_data") g_uiLensSpiSema;
...
static LENSMOTOR_INFO g_LensMotorInfo =
{
    ...
    .LensMotorReg.REG[11] = 0x0080,    // disable IRIS function block (bit10)
    .LensMotorReg.REG[12] = 0x0000,
    .LensMotorReg.REG[13] = 0x0100,
    .LensMotorReg.REG[14] = 0x5501,    // set SPI communication time interval to 303.4 usec = 1*303.4 usec
    .LensMotorReg.REG[15] = 0x0087,
    .LensMotorReg.REG[16] = 0x1601,    // set start excitation time to 303.4 usec = 1*303.4 usec
    .LensMotorReg.REG[17] = STANDBY_PWR_PULSE_WIDTH,
    .LensMotorReg.REG[18] = 0x0000,
    .LensMotorReg.REG[19] = 0x009D,
    .LensMotorReg.REG[20] = 0x1601,
    .LensMotorReg.REG[21] = STANDBY_PWR_PULSE_WIDTH,
    ...
    .LensMotorConfig[0].uiPwmFreq       = 4000,    // must be the same with zoom's one
    ...
    .LensMotorConfig[0].wMaxPulseWidth  = STANDBY_PWR_PULSE_WIDTH,
    ...
    .LensMotorConfig[1].uiPwmFreq       = 4000,    // must be the same with focus's one
    ...
    .LensMotorConfig[1].wMaxPulseWidth  = STANDBY_PWR_PULSE_WIDTH,
