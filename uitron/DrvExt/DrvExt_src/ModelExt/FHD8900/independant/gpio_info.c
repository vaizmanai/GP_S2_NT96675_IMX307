...
GPIO_INIT_OBJ ind_gpio_info_data[] __attribute__((section("modelext_data.gpio_info"))) = {
	...
	{  GPIO_CARD_WP_DET,        GPIO_DIR_INPUT,     PAD_PULLUP,         	PAD_CARD_WP_DET     },
	...
	{  GPIO_VOICE_PWR_ON,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST      },
	//amplifier
	...
	{  GPIO_REC_LED,            GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST       },
	{  GPIO_WIFI_LED,           GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,     PAD_PIN_NOT_EXIST       },
	{  GPIO_POWER_LED,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST       },
    //sensor2
    {  GPIO_SENSOR2_RESET,        GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,       PAD_PIN_NOT_EXIST       },
    {  GPIO_SENSOR2_PWR,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST       },
    {  GPIO_SENSOR2_12VEN,        GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST       },
    {  GPIO_SENSOR2_DET,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST       },
    {  GPIO_SENSOR2_IRQ,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST       },
	{  GPIO_SENSOR_18VEN,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST		 },
	//GPS
	{  GPIO_GPS_PWR_ON,           GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,        PAD_PIN_NOT_EXIST},
	//MCU
	{  GPIO_NOTIFY_MCU,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST       },
	{  GPIO_REC_MODE,		   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST		 },
    {  GPIO_HOLD_DVR_POWER,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,  PAD_PIN_NOT_EXIST       },
    //CAC
