...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
	...
	{PIN_FUNC_SDIO3,            PIN_SDIO_CFG_8BITS | PIN_SDIO_CFG_1ST_PINMUX},
#else
	...
	//
	#if(defined(_Disp_IF8B_LCD1_TXDT270C_8961_6A6_R2_))
	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_SERIAL /*PINMUX_LCDMODE_RGBD320 PINMUX_LCDMODE_RGB_PARALL565*/}, // for ILI9342C
	#else
