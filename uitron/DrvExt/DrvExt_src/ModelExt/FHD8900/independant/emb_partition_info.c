...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
#if 0//defined(_EMBMEM_SPI_NOR_)
#if 1
	#if 0//demo
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00340000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00360000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x003B0000), BLK_UNIT(0x00360000), BLK_UNIT(0x00000000)},
	#else
    [0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00620000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00640000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00690000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
	#endif
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00710000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00710000), BLK_UNIT(0x000F0000), BLK_UNIT(0x00000000)},
#endif
#else
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00710000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00790000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
#endif
#endif
	/*
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	...
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00670000), BLK_UNIT(0x000A0000), BLK_UNIT(0x00000000)},
#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00710000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00710000), BLK_UNIT(0x000F0000), BLK_UNIT(0x00000000)},
	...
	*/
	...
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00340000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00360000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x003B0000), BLK_UNIT(0x00B60000), BLK_UNIT(0x00000000)},
#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00F10000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00F10000), BLK_UNIT(0x000F0000), BLK_UNIT(0x00000000)},
#endif
#else
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00F10000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00F90000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
#endif
#endif
#endif
#elif 0
	...
	#endif
	#endif
	[7] = {EMBTYPE_FAT,     0,  BLK_UNIT(0x07140000), 0x0E00000/*BLK_UNIT(0x01000000)*/, BLK_UNIT(0x00200000)},
