...
#define VOLDET_KEY_ADC_LVL1         (174)
#define VOLDET_KEY_ADC_LVL2         (243)
#define VOLDET_KEY_ADC_LVL3         (350)
#define VOLDET_KEY_ADC_LVL4         (512)
...
UINT32 DrvKey_DetNormalKey(void)
{
	...
	case VOLDET_KEY_LVL_1:
		debug_msg("^Y key_down\r\n");
		uiKeyCode |= FLGKEY_DOWN;	
		break;
		
	case VOLDET_KEY_LVL_0:
		debug_msg("^Y key_shutter2\r\n");
