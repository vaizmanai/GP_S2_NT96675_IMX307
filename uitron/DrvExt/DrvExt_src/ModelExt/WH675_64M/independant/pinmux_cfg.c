...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
    ...
    PIN_I2C_CFG_CH1 |
#endif
#if(defined(_SENSOR1_CMOS_IMX323P_) && defined(_SENSOR2_CMOS_OFF_)) //for TP-LINK
    PIN_I2C_CFG_CH1 |
#endif
	...
	//
	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_SERIAL/*PINMUX_LCDMODE_RGB_THROUGH*/}, // for ILI9342C, LC4300DBW
//	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_PARALL565}, // for ILI9342C
	{PIN_FUNC_TV,               PINMUX_TV_HDMI_CFG_NORMAL},

	{PIN_FUNC_ETH,              PIN_MISC_CFG_NONE/*PIN_ETH_CFG_INTERANL*/},
