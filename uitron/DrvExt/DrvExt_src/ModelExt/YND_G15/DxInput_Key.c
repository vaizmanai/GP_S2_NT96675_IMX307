...
#define VOLDET_KEY_ADC_LVL3			(357)//(460)
#define VOLDET_KEY_ADC_LVL4			(425)  //shutt2
#define VOLDET_KEY_ADC_LVL5			(355)//menu
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    { 
        if((uiKey1ADC>=0)&& 
    		(uiKey1ADC<=VOLDET_KEY_ADC_LVL0+VOLDET_KEY_ADC_RANGE))
    	{
    	//CHKPNT;
               uiCurKey2Lvl = VOLDET_KEY_LVL_MENU;
	}
        else if((uiKey1ADC>=VOLDET_KEY_ADC_LVL1-VOLDET_KEY_ADC_RANGE)&& 
...
/**
  ...
  @return UINT32
*/
#define KEYSCAN_POWEROFF_COUNT  80 //15
