...
/*#if defined(_EMBMEM_SPI_NOR_)
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00400000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x00420000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00490000), BLK_UNIT(0x00100000), BLK_UNIT(0x00000000)},
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00600000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00600000), BLK_UNIT(0x00200000), BLK_UNIT(0x00000000)},
	#endif
	#else
...
#endif  //_EMBMEM_SPI_NOR_
*/
#if defined(_EMBMEM_SPI_NOR_)  // lyg
...
//  [4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00360000), BLK_UNIT(0x000A0000), BLK_UNIT(0x00000000)},
   ...
   [4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00380000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},

    [6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x003D0000), BLK_UNIT(0x00030000), BLK_UNIT(0x00000000)},

    #elif defined(_CPU2_NONE_)

    [4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x00370000), BLK_UNIT(0x00060000), BLK_UNIT(0x00000000)},
    ...
    [5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x00F00000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},

    #if defined(_CPU2_ECOS_)

    [6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00F80000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
