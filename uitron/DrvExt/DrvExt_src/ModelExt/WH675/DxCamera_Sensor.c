...
#endif
#if (defined(_CMOS_IMX323P_)) // for TP-LINK
...
#endif
#if (defined(_CMOS_SC2235P_))
	{"CMOS_SC2235P", sensor_get_drv_tab_sc2235p, sensor_get_obj_sc2235p, sen_power_ctrl_sc2235p, NULL, NULL},
#endif
#if (defined(_CMOS_SC4236M_))
