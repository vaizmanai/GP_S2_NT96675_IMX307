...
#define LCD_MAX_W                       ALIGN_CEIL_16(1440)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(272)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    4
#define LCD_ASPECT_H                    3
#elif defined(_Disp_IF8B_LCD1_LC4300DBW_)
#define LCD_MAX_W                       ALIGN_CEIL_16(1440)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(272)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    4
#define LCD_ASPECT_H                    3
#elif defined(_Disp_IFPA_LCD1_T30P106_)
#define LCD_MAX_W                       ALIGN_CEIL_16(368)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(640)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
{
	// Reset LCD
#if defined(_Disp_IF8B_LCD1_ILI9341_)||defined(_Disp_IF8B_LCD1_ILI9342C_)||defined(_Disp_IFPA_LCD1_T30P106_)
