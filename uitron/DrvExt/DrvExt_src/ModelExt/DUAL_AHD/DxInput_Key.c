...
////////////////////////////////////////////////////////////////////////////////
#if (ADC_KEY == ENABLE)
#define VOLDET_KEY_ADC_LVL0          (122)
#define VOLDET_KEY_ADC_LVL1          (254)
#define VOLDET_KEY_ADC_LVL2          (511)
...
static UINT32 VolDet_GetKey1Level(void)
{
	...
	if (uiKey1ADC < VOLDET_KEY_ADC_LVL0/2) {
		uiCurKey2Lvl = VOLDET_KEY_LVL_0;
	} else if (uiKey1ADC < (VOLDET_KEY_ADC_LVL0/2+VOLDET_KEY_ADC_LVL1/2)){
		uiCurKey2Lvl = VOLDET_KEY_LVL_1;
	} else if (uiKey1ADC < (VOLDET_KEY_ADC_LVL1/2+VOLDET_KEY_ADC_LVL2/2)){
...
static UINT32 VolDet_GetKey2Level(void)
{
	...
	//debug_msg("uiKey2ADC %d \r\n", uiKey2ADC);
	if (uiKey2ADC < VOLDET_KEY_ADC_LVL0/2) {
		uiCurKey2Lvl = VOLDET_KEY_LVL_0;
	} else if (uiKey2ADC < (VOLDET_KEY_ADC_LVL0/2+VOLDET_KEY_ADC_LVL1/2)){
		uiCurKey2Lvl = VOLDET_KEY_LVL_1;
	} else if (uiKey2ADC < (VOLDET_KEY_ADC_LVL1/2+VOLDET_KEY_ADC_LVL2/2)){
		uiCurKey2Lvl = VOLDET_KEY_LVL_2;
	} else 
		uiCurKey2Lvl = VOLDET_KEY_LVL_UNKNOWN;
