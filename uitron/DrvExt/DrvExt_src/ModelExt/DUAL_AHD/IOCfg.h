...
#define GPIO_NULL	D_GPIO_0
#define PAD_GPIO_NULL	PAD_PIN_DGPIO0
...
#define GPIO_LCD_RESET              GPIO_NULL
...
#define GPIO_GSENSOR_SWITCH			P_GPIO_12
#define GPIO_G_P_EN			C_GPIO_10
...
// CARD
// SD card power
#define GPIO_CARD_POWER             GPIO_NULL
#define PAD_CARD_POWER              PAD_GPIO_NULL
// SD card detect
#define GPIO_CARD_DETECT            P_GPIO_18
#define PAD_CARD_DETECT             PAD_PIN_PGPIO18
// SD card write protect (useless)
#define GPIO_CARD_WP                C_GPIO_2
#define PAD_CARD_WP                 PAD_PIN_CGPIO2
...
#define GPIO_AMP_POWER				P_GPIO_19
#define PAD_AMP_POWER				PAD_PIN_PGPIO19
...
#define GPIO_TVI1_POWER_EN			P_GPIO_3
#define GPIO_TVI2_POWER_EN			P_GPIO_4
#define GPIO_TVI_RESET				C_GPIO_6

#define GPIO_TVI_12EN				P_GPIO_2

#define GPIO_TVI_DET1				C_GPIO_7
#define PAD_TVI_DET1				PAD_PIN_CGPIO7
#define GPIO_TVI_DET2				C_GPIO_5
#define PAD_TVI_DET2				PAD_PIN_CGPIO5
...
//--------------------------------------------------------------------
// WiFi
#define GPIO_WIFI_REG_ON			GPIO_NULL// WiFi regulator on, high active
#define GPIO_WIFI_PWR_ON			GPIO_NULL // WiFi power on, high active
