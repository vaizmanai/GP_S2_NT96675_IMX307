...
//	{  GPIO_AMP_SHDN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_AMP_SHDN		},
	...
	{  GPIO_TVI1_POWER_EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST	},
	{  GPIO_TVI2_POWER_EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST	},
	
	{  GPIO_TVI_12EN,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		PAD_PIN_NOT_EXIST	},
	{  GPIO_TVI_DET1,			GPIO_DIR_INPUT,		PAD_PULLDOWN,			PAD_TVI_DET1		},
	{  GPIO_TVI_DET2,			GPIO_DIR_INPUT,		PAD_PULLDOWN,			PAD_TVI_DET2		},

     {  GPIO_GSENSOR_SWITCH,          GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW ,  PAD_PIN_NOT_EXIST       },
     {  GPIO_G_P_EN,          GPIO_DIR_OUTPUT,   GPIO_SET_OUTPUT_HI ,  PAD_PIN_NOT_EXIST       },
