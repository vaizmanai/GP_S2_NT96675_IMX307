...
EMB_PARTITION ind_emb_partition_info_data[EMB_PARTITION_INFO_COUNT] __attribute__((section("modelext_data.emb_partition_info"))) = {
	...
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00010000), BLK_UNIT(0x00010000), BLK_UNIT(0x00000000)},
	[2] = {EMBTYPE_UITRON,  0,  BLK_UNIT(0x00020000), BLK_UNIT(0x00380000), BLK_UNIT(0x00000000)},
	[3] = {EMBTYPE_UBOOT,   0,  BLK_UNIT(0x003A0000), BLK_UNIT(0x00050000), BLK_UNIT(0x00000000)},
	[4] = {EMBTYPE_PSTORE,  0,  BLK_UNIT(0x003F0000), BLK_UNIT(0x000C0000), BLK_UNIT(0x00000000)},
	#if defined(_DSP1_NONE_)
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x004B0000), BLK_UNIT(0x00000000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x004B0000), BLK_UNIT(0x000F0000), BLK_UNIT(0x00000000)},
	#endif
	#else
	[5] = {EMBTYPE_DSP,     0,  BLK_UNIT(0x004B0000), BLK_UNIT(0x00080000), BLK_UNIT(0x00000000)},
	#if defined(_CPU2_ECOS_)
	[6] = {EMBTYPE_ECOS,    0,  BLK_UNIT(0x00530000), BLK_UNIT(0x00070000), BLK_UNIT(0x00000000)},
	#endif
	#endif
	[7] = {EMBTYPE_USER0,     0,  BLK_UNIT(0x005A0000), BLK_UNIT(0x00A20000), BLK_UNIT(0x00000000)},//DSA , 10 MB+128KB
	[8] = {EMBTYPE_USER1,     0,  BLK_UNIT(0x00FC0000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},//TSR Model, 256 KB
#else
	[0] = {EMBTYPE_LOADER,  0,  BLK_UNIT(0x00000000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
	[1] = {EMBTYPE_MODELEXT, 0, BLK_UNIT(0x00040000), BLK_UNIT(0x00040000), BLK_UNIT(0x00000000)},
