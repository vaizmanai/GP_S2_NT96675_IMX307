...
#define VOLDET_KEY_ADC_LVL0				(50+VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL1				(150+VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2				(250+VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3				(350+VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4				(400+VOLDET_KEY_ADC_RANGE)
...
static UINT32 VolDet_GetKey1Level(void)
{
	...
	if (uiKey1ADC < VOLDET_KEY_ADC_LVL0) {
		...
		uiCurKey2Lvl = VOLDET_KEY_ADC_LVL4;
	}
...
UINT32 DrvKey_DetNormalKey(void)
{
	...
	case VOLDET_KEY_LVL_0:
		...
		uiKeyCode |= FLGKEY_RIGHT; // for NVT UI
		break;
	case VOLDET_KEY_LVL_1:
		//uiKeyCode |= FLGKEY_ENTER;
		uiKeyCode |= FLGKEY_SHUTTER2; // for NVT UI
		break;
