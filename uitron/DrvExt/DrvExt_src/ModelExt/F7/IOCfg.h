...
#else
#define GPIO_NULL                   L_GPIO_0
#define PAD_NULL                    PAD_PIN_LGPIO0
...
#else
#define GPIO_LCD_RESET              L_GPIO_20//L_GPIO_20
#define GPIO_LCD_POWER_EN           GPIO_NULL//P_GPIO_8
#endif
...
#else
#define GPIO_LCD_BLG_PCTL           P_GPIO_19//D_GPIO_0
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO19//PAD_PIN_DGPIO0
#endif
#endif
...
// CARD
// SD card power
#define GPIO_CARD_POWER             GPIO_NULL//P_GPIO_9//3
#define PAD_CARD_POWER              PAD_NULL//PAD_PIN_PGPIO9//3
// SD card detect
...
#define PAD_CARD_WP                 PAD_NULL//PAD_PIN_PGPIO24
...
#define GPIO_KEY_LEFT               GPIO_NULL//P_GPIO_24           // Key Left (kl)
#define PAD_KEY_LEFT                PAD_NULL//PAD_PIN_CGPIO24
...
#define GPIO_TP_DOUT                GPIO_NULL//P_GPIO_8 //P_GPIO_58 //HW TP_DI  =SBDAT0/AGPIO-26   (FW output = HW input)
...
#define GPIO_RED_LED                P_GPIO_23//D_GPIO_1
#define PAD_RED_LED                 PAD_PIN_PGPIO23//PAD_PIN_DGPIO1


#define GPIO_POWER_LED              GPIO_NULL //Yellow
#define GPIO_REC_LED                GPIO_NULL  //RED
#define GPIO_WIFI_LED               GPIO_NULL  //Blue

#define LED_BLUE_DUMMY               0
#define LED_BLUE_BY_GPIO             1
#define LED_BLUE_BY_MCU              3
#define LED_BLUE_CTRL                LED_RED_DUMMY
#define GPIO_BLUE_LED                GPIO_NULL  //FPGA  // WIFI LED
#define PAD_BLUE_LED                 GPIO_NULL
...
#define GPIO_GREEN_LED              C_GPIO_6
#define PAD_GREEN_LED               PAD_PIN_CGPIO6
...
#define GPIO_AMP_POWER              P_GPIO_25//P_GPIO_10//19
#define PAD_AMP_POWER               PAD_PIN_PGPIO25 //PAD_PIN_PGPIO10//19
...
//ACC
#define GPIO_ACC_DET                 D_GPIO_1
#define PAD_ACC_DET                  PAD_PIN_DGPIO1
...
#define GPIO_SENSOR_29VEN           S_GPIO_5
#define GPIO_SENSOR_18VEN           S_GPIO_5
#define GPIO_SENSOR_12VEN           S_GPIO_5
#endif
#define GPIO_SENSOR2_RESET           P_GPIO_9
#define GPIO_SENSOR2_PWR             L_GPIO_19
#define GPIO_SENSOR2_PDN             P_GPIO_17             
#define GPIO_SENSOR2_12VEN           GPIO_NULL
#define GPIO_SENSOR2_DET             GPIO_NULL
#define GPIO_SENSOR2_IRQ             GPIO_NULL
...
#else
#define GPIO_WIFI_REG_ON            P_GPIO_17//4 // WiFi regulator on, high active
//#define GPIO_WIFI_PWR_ON            P_GPIO_24//2 // WiFi power on, high active
#endif
//--------------------------------------------------------------------
// Storbe device
//--------------------------------------------------------------------
...
extern BOOL GPIOMap_AccSignalDetect(void);
