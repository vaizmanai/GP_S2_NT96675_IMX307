...
#define VOLDET_BATTERY_380V         390
#define VOLDET_BATTERY_376V         385
#define VOLDET_BATTERY_371V         380
#define VOLDET_BATTERY_355V         360
#define VOLDET_BATTERY_350V         350
#define VOLDET_BATTERY_340V         340
...
static UINT32 DrvPower_GetBatteryLevel(void)
{
	...
	DBG_MSG("uiCurBatteryLvl:%d uiCurBatteryADC:%d\r\n", uiCurBatteryLvl, uiCurBatteryADC);
...
static void DrvPower_dummy_process(UINT32 *V1, UINT32 *V2, BOOL bIris)
{
	...
	*V2 = Vtotal / DetectLoop;
	...
	debug_msg("delta=(%1.3f, %d) Ave_V:%1.3f V2:%1.3f, %d, %d, Cal = %d \r\n", Vtmp3, (*V2) - (*V1), Vtmp1, Vtmp2, *V1, *V2, iBattAdcCalOffset);
...
*/
#if 0
UINT32 ExternDxPower_GetControl(DRVPWR_CTRL DrvPwrCtrl)
{
    return DrvPower_GetControl(DrvPwrCtrl);
}
#endif
