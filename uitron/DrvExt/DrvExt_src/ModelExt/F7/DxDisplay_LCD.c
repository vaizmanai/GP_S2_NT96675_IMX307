...
#define LCD_ASPECT_W                    4
#define LCD_ASPECT_H                    3
#elif defined(_Disp_IF8B_LCD1_ILI9342C_NB03_)
#define LCD_MAX_W                       ALIGN_CEIL_16(240)//(320)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(320)//(240)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    3
#define LCD_ASPECT_H                    4
...
{
	// Reset LCD
#if (defined(_Disp_IF8B_LCD1_ILI9341_) || defined(_Disp_IF8B_LCD1_ILI9342C_) || defined(_Disp_IF8B_LCD1_ILI9342C_NB03_))
