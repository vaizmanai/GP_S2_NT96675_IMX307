...
static SENSOR_INIT_OBJ sensor_get_obj_gc2053p(SENSOR_ID id)
{
	...
	init_obj.option = SENSOR_OPTION_MIRROR | SENSOR_OPTION_FLIP;
    /*init_obj.signal_info.vd_phase= 1;//_FALLING;
    init_obj.signal_info.hd_phase=1;
    init_obj.signal_info.data_phase=1;*/
	CHKPNT;
	return init_obj;
}
static void sen_power_ctrl_gc2053p(SENSOR_ID id, POW_CTRL_FLAG flag)
{
	...
	case POW_CTRL_TURN_ON:
		// set clock information
		sensor_if_get_pll_ctrl_obj()->set_clk_en(id, SEN_CLK_SIEMCLK, ENABLE);
        sensor_if_get_pll_ctrl_obj()->set_clk_freq(id, SEN_CLK_SIEMCLK, 24000000);
		// set power on sequence
        CHKPNT;
		gpio_setDir(GPIO_SENSOR_12VEN, GPIO_DIR_OUTPUT);
		gpio_setDir(GPIO_SENSOR_18VEN, GPIO_DIR_OUTPUT);
...
#if (defined(_CMOS_TVP5150_))
static SENSOR_INIT_OBJ sensor_get_obj_TVP5150(SENSOR_ID id)
{
	CHKPNT;
	// set sensor command interface info (Vx1/SIF/I2C/IO/...)
	SENSOR_INIT_OBJ init_obj = {0};
...
static void sen_power_ctrl_tvp5150(SENSOR_ID id, POW_CTRL_FLAG flag)
{
	switch (flag) {
	case POW_CTRL_TURN_ON:
		...
		pll_setPLL(PLL_ID_4,			  0xE516F);//54MHz
		pll_setPLLEn(PLL_ID_4,			ENABLE);

		*((UINT32 *)0xC0010018) &= ~(0x3<<10);
        *((UINT32 *)0xC0010018) |= (0x1<<10);
		//*((UINT32 *)0xC0010018) |= 0x4000;
		*((UINT32 *)0xC00100a8) &= 0xfeffffff;

		*((UINT32 *)0xC0020024) &= ~(0x3<<10);
		*((UINT32 *)0xC0020024) |= (0x1<<10);
		//*((UINT32 *)0xC0020024) |= 0x4000;
		*((UINT32 *)0xC0020000) |= 0x10;
		*((UINT32 *)0xC0020040) &= 0x00ffffff;
		*((UINT32 *)0xC0020040) |= 0x05000000;
		*((UINT32 *)0xC0020074) |= 0x40000000;
		*(UINT32 *)0xC00100A8 &= ~0xff;
...
static BOOL sen_det_plug_in_tvp5150(SENSOR_ID id)
{
#if 1
	//return TRUE;
	BOOL rt = E_OK;
...
#endif
#if (defined(_CMOS_TVP5150_))
	{"CMOS_TVP5150", sensor_get_drv_tab_tvp5150, sensor_get_obj_TVP5150, sen_power_ctrl_tvp5150, sen_det_plug_in_tvp5150, NULL},
#endif
