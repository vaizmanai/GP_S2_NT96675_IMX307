...
PIN_GROUP_CONFIG ind_pinmux_cfg_data[] __attribute__((section("modelext_data.pinmux_cfg"))) = {
...
#elif (defined(_SENSOR1_CMOS_IMX323P_) && defined(_SENSOR2_CMOS_TP2825_))
...
#elif (defined(_SENSOR1_CMOS_IMX291M_) && defined(_SENSOR2_CMOS_TP2825_1080P_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_CCIR8BITS|PIN_SENSOR2_CFG_MCLK},
	{
		PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_TP2825_))
	{PIN_FUNC_SENSOR,			PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
	{PIN_FUNC_SENSOR2,			PIN_SENSOR2_CFG_CCIR8BITS | PIN_SENSOR2_CFG_MCLK},
	{
		PIN_FUNC_MIPI_LVDS,
...
#elif (defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_GM7150_))
	{PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI | PIN_SENSOR_CFG_MCLK},
...
#endif
#if (defined(_SENSOR1_CMOS_IMX291M_) && defined(_SENSOR2_CMOS_TP2825_1080P_))
    PIN_I2C_CFG_CH1 |PIN_I2C_CFG_CH2|
#endif
#if (defined(_SENSOR1_CMOS_IMX323P_) && defined(_SENSOR2_CMOS_TP2825_))
    PIN_I2C_CFG_CH1 |PIN_I2C_CFG_CH2|
#endif
    ...
    PIN_I2C_CFG_CH1 |
		...
		PIN_I2C_CFG_CH2 |
#endif
#if(defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_TP2825_))
		PIN_I2C_CFG_CH1 | PIN_I2C_CFG_CH2 |
#endif
		...
		PIN_I2C_CFG_CH1 |
#endif
#if (defined(_SENSOR1_CMOS_GC2053M_) && defined(_SENSOR2_CMOS_GM7150_))
		PIN_I2C_CFG_CH1 | PIN_I2C_CFG_CH3 |
#endif
		0
	},
	...
	//
	{PIN_FUNC_LCD,              PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_THROUGH /*PINMUX_LCDMODE_RGB_PARALL565*/}, // for ILI9342C
