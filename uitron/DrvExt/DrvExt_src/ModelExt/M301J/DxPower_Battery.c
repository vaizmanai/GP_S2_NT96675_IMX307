...
#define VOLDET_BATTERY_380V        380// 390
#define VOLDET_BATTERY_376V         365 //385
#define VOLDET_BATTERY_371V         350
#define VOLDET_BATTERY_355V         335//360
#define VOLDET_BATTERY_350V         325
#define VOLDET_BATTERY_340V         315
...
UINT32 DrvPower_GetBatteryADC2(void);
UINT32 DrvPower_GetBatteryADC2(void)
{
...
static UINT32 DrvPower_GetBatteryLevel(void)
{
	...
	//debug_msg("uiCurBatteryLvl:%d uiCurBatteryADC:%d\r\n", uiCurBatteryLvl, uiCurBatteryADC);
