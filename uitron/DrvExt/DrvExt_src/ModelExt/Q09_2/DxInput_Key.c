...
////////////////////////////////////////////////////////////////////////////////
#if (ADC_KEY == ENABLE)
#define VOLDET_KEY_ADC_LVL0         (10)
#define VOLDET_KEY_ADC_LVL1         (150)
...
UINT32 DrvKey_DetNormalKey(void)
{
	...
	//debug_msg("DrvKey_DetNormalKey    lv1=%d,    lv2=%d \r\n", uiKey1Lvl, uiKey2Lvl);
	switch (uiKey1Lvl) {
	...
	case VOLDET_KEY_LVL_0:
		uiKeyCode |= FLGKEY_MENU;//FLGKEY_DOWN;
		break;
	}
	switch (uiKey2Lvl) {
	case VOLDET_KEY_LVL_0:
		uiKeyCode |= FLGKEY_DOWN;//FLGKEY_MENU;
		break;
	case VOLDET_KEY_LVL_1:
		uiKeyCode |= FLGKEY_SHUTTER2;//FLGKEY_ENTER;
		break;
	}
#endif
