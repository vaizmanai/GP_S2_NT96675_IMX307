...
#define GPIO_SENSOR_1_8_EN            S_GPIO_4
#define GPIO_SENSOR_1_2_EN            S_GPIO_5
#define GPIO_SENSOR_2_9_EN            S_GPIO_6
...
#define GPIO_WIFI_PWR_ON			C_GPIO_10 //P_GPIO_2 // WiFi power on, high active
