...
#define LCD_MAX_H                       ALIGN_CEIL_16(800)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    3
#define LCD_ASPECT_H                    5
#elif defined(_Disp_IFPA_LCD1_T30P106_)
#define LCD_MAX_W                       ALIGN_CEIL_16(480)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(360)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    4
#define LCD_ASPECT_H                    3
#else
#define LCD_MAX_W                       ALIGN_CEIL_16(320)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
#if defined(_Disp_IF8B_LCD1_ILI9342C_) //modify for fix power on white display
    GPIOMap_LCDReset();
...
{
	// Reset LCD
#if defined(_Disp_IF8B_LCD1_ILI9342C_)
	SwTimer_DelayMs(50);
