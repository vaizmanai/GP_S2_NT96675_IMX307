...
AUDIO_GAIN gCurDrvSndGain = AUDIO_GAIN_6;//AUDIO_GAIN_4;
...
void DrvSound_SetAudioFeature(void)
{
	...
	aud_setFeature(AUDIO_FEATURE_ALC, DISABLE);
	aud_setParameter(AUDIO_PARAMETER_BOOST_GAIN, EAC_PGABOOST_SEL_20DB);
	aud_setFeature(AUDIO_FEATURE_ALC, ENABLE);
