...
GPIO_INIT_OBJ ind_gpio_info_data[] __attribute__((section("modelext_data.gpio_info"))) = {
...
#endif
       {  GPIO_SENSOR_EN,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST	},
       {  GPIO_MIC_POWER_AMPLIFIER,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST	},
	...
	{  GPIO_KEY_SOS,          GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_KEY_SOS},

	{  GPIO_Motor,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_PIN_NOT_EXIST	}, // high active
	{  GPIO_LCD_DATEENABLE,		GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,	PAD_PIN_NOT_EXIST	}, 



	//Edog onoff
	//{  GPIO_EDOG_CTL,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_LOW,	PAD_EDOG_CTL		},
	// {  GPIO_5150_POWER,			GPIO_DIR_INPUT,	GPIO_SET_OUTPUT_LOW,		GPIO_SET_NONE		},
       {  GPIO_5150_BackIn,            GPIO_DIR_INPUT,       PAD_PULLDOWN,       PAD_5150_BackIn},
	//lhb add LED @20190109---------------------------------------------------------------------------------
	{  LHB_GPIO_REC_LED,			GPIO_DIR_OUTPUT,	GPIO_SET_OUTPUT_HI,		GPIO_SET_NONE		},
