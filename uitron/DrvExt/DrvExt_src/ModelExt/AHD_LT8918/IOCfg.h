...
// mic  power amplifier
//--------------------------------------------------------------------
#define  GPIO_MIC_POWER_AMPLIFIER    D_GPIO_1
...
#define GPIO_LCD_RESET                  L_GPIO_20 //   C_GPIO_7 // L_GPIO_20
#define GPIO_LCD_POWER_EN           P_GPIO_7
#define GPIO_LCD_BLG_PWR            GPIO_LCD_POWER_EN
#define GPIO_LCD_DATEENABLE            P_GPIO_25

#define GPIO_Motor 				P_GPIO_8
// LCD backlight
...
#define GPIO_LCD_BLG_PCTL          D_GPIO_0 //   D_GPIO_1 // P_GPIO_0//D_GPIO_0
#define PAD_LCD_BLG_PCTL           PAD_PIN_DGPIO0 //  PAD_PIN_DGPIO1
#endif
...
#define GPIO_LCD2_SIF_SCK          P_GPIO_23 //  P_GPIO_25 //FPGA --- NOTE! it will conflict with PIN_SIF_CFG_CH2
...
// CARD
// SD card power
#define GPIO_CARD_POWER             P_GPIO_3
#define PAD_CARD_POWER              PAD_PIN_PGPIO3
// SD card detect
...
#define GPIO_KEY_ENTER             P_GPIO_6 // P_GPIO_25           // Key OK (ke)
...
#define GPIO_TP_DOUT                P_GPIO_7 //P_GPIO_58 //HW TP_DI  =SBDAT0/AGPIO-26   (FW output = HW input)
...
#define GPIO_POWER_LED           P_GPIO_6 //   P_GPIO_25 //Yellow
...
#define GPIO_BLUE_LED                P_GPIO_6 // P_GPIO_25  //FPGA  // WIFI LED
#define PAD_BLUE_LED                PAD_PIN_PGPIO6 // PAD_PIN_PGPIO25
...
//VOICE
#define GPIO_VOICE_BUSY_DET         P_GPIO_7 //5
#define PAD_VOICE_BUSY_DET          PAD_PIN_PGPIO7 //5
#define GPIO_VOICE_DATA             P_GPIO_7
#define PAD_VOICE_DATA              PAD_PIN_PGPIO7

//power amplifier module
#define GPIO_AMP_POWER              P_GPIO_10//19
#define PAD_AMP_POWER               PAD_PIN_PGPIO10//19

#define GPIO_AMP_SHDN               P_GPIO_6
#define PAD_AMP_SHDN                PAD_PIN_PGPIO6
...
#define GPIO_SENSOR_EN         P_GPIO_6 //   P_GPIO_25
#define  GPIO_5150_BackIn    P_GPIO_19
#define  PAD_5150_BackIn     PAD_PIN_PGPIO19
...
//--------------------------------------------------------------------
// WiFi
#define GPIO_WIFI_REG_ON			P_GPIO_4 // WiFi regulator on, high active
#define GPIO_WIFI_PWR_ON			P_GPIO_2 // WiFi power on, high active
...
#define LHB_GPIO_REC_LED     C_GPIO_5
