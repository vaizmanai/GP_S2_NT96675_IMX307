...
#define LCD_TYPE_ILI9342_FPC_FD234021000_1 	7
#define LCD_TYPE_ILI9342_FPC_FD234021000_2  8
#define LCD_TYPE_ILI9342_FPC_FD234021000_3  9


#define LCD_TYPE_  LCD_TYPE_ILI9342_FPC_FD234021000_3 // LCD_TYPE_ILI9342_FPC_FD234021000//LCD_TYPE_ILI9342_C_HS_231//LCD_TYPE_ILI9342_C_TM_231
...
*/
        ...
        {IFCMD_CMD, 0x29},     //Display ON 
        {CMDDELAY_MS, 180}
#elif(LCD_TYPE_ == LCD_TYPE_ILI9342_FPC_FD234021000_1)
		 {IFCMD_CMD, 0x01},
        {CMDDELAY_MS, 10},
        ...
        {IFCMD_DATA,0x08},//MY,MX,MV,ML,BGR,MH跟之前一样的设置即可

        {IFCMD_CMD, 0x3A},  //Pixel Format Set
        {IFCMD_DATA,0x55},//跟之前一样的设置即可
        
        {IFCMD_CMD, 0xC0},  //Power Control 1
        {IFCMD_DATA,0x13},//VRH[5:0]
        {IFCMD_DATA,0x0E},//VC[3:0]  
        
        {IFCMD_CMD, 0xC1},   //Power Control 2
        {IFCMD_DATA,0x02},//SAP[2:0],BT[3:0]
 
        {IFCMD_CMD, 0xC5},   //VCOM
        {IFCMD_DATA,0xD5}, //{IFCMD_DATA,0xD5}

         {IFCMD_CMD, 0xB0},  //RGB 设置，影响显示   
        {IFCMD_DATA,0xE0},
		...
		{IFCMD_CMD, 0xE0},                      
		{IFCMD_DATA,0x00},//P01-VP63            
		{IFCMD_DATA,0x07},//P02-VP62            
		{IFCMD_DATA,0x0C},//P03-VP61            
		{IFCMD_DATA,0x06},//P04-VP59            
		{IFCMD_DATA,0x15},//P05-VP57            
		{IFCMD_DATA,0x09},//P06-VP50            
		{IFCMD_DATA,0x3A},//P07-VP43            
		{IFCMD_DATA,0x36},//P08-VP27,36         
		{IFCMD_DATA,0x48},//P09-VP20            
		{IFCMD_DATA,0x02},//P10-VP13            
		{IFCMD_DATA,0x0B},//P11-VP6             
		{IFCMD_DATA,0x0A},//P12-VP4             
		{IFCMD_DATA,0x15},//P13-VP2             
		{IFCMD_DATA,0x16},//P14-VP1             
		{IFCMD_DATA,0x0F},//P15-VP0    
...
#elif(LCD_TYPE_ == LCD_TYPE_ILI9342_FPC_FD234021000_2)
		 {IFCMD_CMD, 0x01},
        {CMDDELAY_MS, 10},
        ...
        //{IFCMD_CMD, 0x2C},  
		 ...
		 {CMDDELAY_MS, 50},	
#elif(LCD_TYPE_ == LCD_TYPE_ILI9342_FPC_FD234021000_3)
		 {IFCMD_CMD, 0x01},
        {CMDDELAY_MS, 100},
		 {IFCMD_CMD, 0x01},
        {CMDDELAY_MS, 100},
        ...
        {IFCMD_CMD, 0xC1},   //Power Control 2
        {IFCMD_DATA,0x00},//{IFCMD_DATA,0x02},//SAP[2:0],BT[3:0]
...
const tLCD_PARAM tMode[] =
{
    /***********       RGB-SERIAL MODE         *************/
    {
        // tPANEL_PARAM
        {
            ...
            10.3,//31.0f,//27.0f,//27.0f,                           //!< fDCLK
            1716,                            //!< uiHSyncTotalPeriod
            960,//960,                            //!< uiHSyncActivePeriod
            20,//20,    //21                         //!< uiHSyncBackPorch
