...
static ER dispdev_openIF8Bits(void)
{
	...
	DevIOCtrl.SEL.SET_DISPSIZE.uiBufWidth     = 320;
	DevIOCtrl.SEL.SET_DISPSIZE.uiBufHeight    = 240;
	DevIOCtrl.SEL.SET_DISPSIZE.uiWinWidth     = 320;
	DevIOCtrl.SEL.SET_DISPSIZE.uiWinHeight    = 240;
...
static ER dispdev_getLcdSize(PDISPDEV_GET_PRESIZE tLCDSize)
{
	tLCDSize->uiBufWidth = 320;
	tLCDSize->uiBufHeight = 240;
	return E_OK;
}
