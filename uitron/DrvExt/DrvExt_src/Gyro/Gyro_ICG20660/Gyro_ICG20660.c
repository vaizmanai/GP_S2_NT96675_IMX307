...
{
    0x6B,    0x01,      // PWR_MGMT_1, Reset
    0xFF,    0x01,      // delay 1 ms
    0x1B,    0x08,      // Gyroscope Configuration FS_SEL set 1 ,+-250dps
    //0x1C,    0x00,      // Accelerometer Configuration ACCEL_FS_SEL set 0 , +-2g
    0x1C,    0x18,      // Accelerometer Configuration ACCEL_FS_SEL set 3 , +-16g
    0x1F,    0x85,      // Wake-on Motion Threshold,
    0x37,    0xC0,      // interrupt
    0x38,    0xE0,      // enable WoM interrupt
