 ...
 */
AVAPI2_API void AVAPI2_ServerStop(void);
 ...
 */
AVAPI2_API void AVAPI2_ClientStop(void);
...
AVAPI2_API void AVAPI2_PrintfBuf(void);

AVAPI2_API int AVAPI2_SendFrameDataWithTime(int nAVCanal, unsigned short usCodecID, unsigned char bFrameFlags, unsigned int nTimestamp, char* pFrameBuf, int nFrameSize);

AVAPI2_API int AVAPI2_SendAudioDataWithTime(int nAVCanal, unsigned short usCodecID, unsigned char bFrameFlags, unsigned int nTimestamp, char* pAudioData, int nAudioSize);
