...
extern void send_msgq(void);
extern void wpa_supplicant_main(bool is_wow);
extern void *wpa_supplicant_get_notification(void);
//extern void nvt_wpa_supplicant_ctrl_iface_process(char *buf, size_t *resp_len);
extern char * wpa_supplicant_ctrl_iface_process(
                    /*struct wpa_supplicant*/void *wpa_s,
					 char *buf, size_t *resp_len);

extern struct wpa_supplicant *get_global_wpasupplicant(void);

extern void show_monitor_tick(void);
/**
 ...
 *      -# 0: successed
 */
extern int nvt_wpa_supplicant_init(bool is_wow);

extern enum scan_status get_scan_status(void);

extern int nvt_getWlSiteSurveyResult(NTK_BSS_INFO_T *pSSStatus);

extern int nvt_checkScanResultReady(void);

extern bool nvt_check_wpa_supplicant_associated(void);
