...
typedef enum _NVT_BANDWIDTH_TYPE {
    NVT_WIFI_BANDWIDTH_20MHZ = 20,
    NVT_WIFI_BANDWIDTH_40MHZ = 40,
    NVT_WIFI_BANDWIDTH_80MHZ = 80
} NVT_BANDWIDTH_TYPE;
...
#else
__externC int NvtWifiECOS_CmdLine(char *szCmd, char *szRcvAddr, char *szSndAddr, char *szVer);
#endif
