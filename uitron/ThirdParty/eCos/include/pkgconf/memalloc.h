...
#define CYGNUM_MEMALLOC_ALLOCATOR_DLMALLOC_ALIGNMENT 5
#define CYGNUM_MEMALLOC_ALLOCATOR_DLMALLOC_ALIGNMENT_5
#define CYGSEM_MEMALLOC_ALLOCATOR_SEPMETA_THREADAWARE 1
#define CYGPKG_MEMALLOC_MALLOC_ALLOCATORS 1
#define CYGPKG_MEMALLOC_MALLOC_IMPLEMENTATION 1
...
#define CYGPKG_MEMALLOC_MALLOC_DEBUG 1
#define CYGDBG_MEMALLOC_MALLOC_DEBUG_FILL_FREE 0x000000FF
#define CYGDBG_MEMALLOC_MALLOC_DEBUG_FILL_FREE_0x000000FF
