...
#include <stddef.h>           // Definition of NULL from the compiler
    ...
    //used for checking which __attribute__((init_priority(X))) syntax to use,  
    //this syntax had been changed starting from GCC version 3.4.0 
    #if (GCC_VERSION >= 30400)
        #define GNUC_VER_NEWER_THAN_3_4_0   1
    #else
        #define GNUC_VER_NEWER_THAN_3_4_0   0
    #endif
#else    
    #define GNUC_VER_NEWER_THAN_3_4_0   0
#endif
...
//#warning ( "No CYGBLD_ATTRIB_INIT_PRI defined!" )
#endif
