...
#define PRId_PROCESSOR_24K                0x00009300
#define PRId_PROCESSOR_24KE               0x00009600
...
#ifdef CYGHWR_HAL_MIPS_NT96660_BIT_INDEXING
// HAL variation is chosen to support bit indexing
#define HAL_LSBIT_INDEX(index, mask) index = __builtin_ctz((mask));

#define HAL_MSBIT_INDEX(index, mask) index = __builtin_clz((mask));
