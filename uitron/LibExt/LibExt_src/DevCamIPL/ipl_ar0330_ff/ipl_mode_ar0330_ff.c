...
static IPL_SEN_MODE_SEL_INFO sensor_mode_sel_table[] = {
	...
	{2048,   1536, 	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_2},
...
IPL_EXT_LIB_TAB *IPL_AR0330_FF_EXT_LIB_TAB(void)
{
