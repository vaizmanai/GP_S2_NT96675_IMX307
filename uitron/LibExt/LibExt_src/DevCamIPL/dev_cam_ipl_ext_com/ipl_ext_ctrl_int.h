...
void IPL_CtrlInitIpc_SIEIn_Cap(UINT32 id, IPC_SIE_Info *ipl_sie_info);
void IPL_CtrlInitIpc_SIEOB_Cap(UINT32 id, SIE_UPDATE *Update1, SIE_SUBFUNC *sie_sub_func);
