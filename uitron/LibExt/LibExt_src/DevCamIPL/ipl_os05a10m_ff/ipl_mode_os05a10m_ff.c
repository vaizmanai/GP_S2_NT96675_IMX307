...
static IPL_SEN_MODE_SEL_INFO sensor_mode_sel_table[] = {
	...
	{2592,   1944, 	IPL_UTI_CONV2_UINT32(30, 1),	SEL_SHDR_FRAME_NONE,	SENSOR_MODE_1},
#endif
};
...
IPL_EXT_LIB_TAB *IPL_OS05A10M_FF_EXT_LIB_TAB(void)
{
