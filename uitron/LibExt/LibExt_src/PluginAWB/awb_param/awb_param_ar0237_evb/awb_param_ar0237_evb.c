...
/**
    CT gain
*/
#define AWB_CT_2300K_RGAIN 237
#define AWB_CT_2300K_BGAIN 824

#define AWB_CT_2800K_RGAIN 267
#define AWB_CT_2800K_BGAIN 717

#define AWB_CT_3700K_RGAIN 312
#define AWB_CT_3700K_BGAIN 605

#define AWB_CT_4700K_RGAIN 363
#define AWB_CT_4700K_BGAIN 494

#define AWB_CT_6500K_RGAIN 404
#define AWB_CT_6500K_BGAIN 345

#define AWB_CT_11000K_RGAIN 496
#define AWB_CT_11000K_BGAIN 288
...
void awb_get_param_ar0237_evb(UINT32* param);

void awb_get_param_ar0237_evb(UINT32* param)
{
	*param = (UINT32)(&awb_param_ar0237_evb);
}
