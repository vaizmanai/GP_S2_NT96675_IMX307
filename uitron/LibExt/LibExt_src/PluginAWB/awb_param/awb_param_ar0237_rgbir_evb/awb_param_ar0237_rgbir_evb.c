/**
    ...
    @file       awb_ar0237_rgbir_param_evb
    @ingroup    LibExt\AWB
...
/**
    CT gain
*/
#define AWB_CT_2300K_RGAIN 203
#define AWB_CT_2300K_BGAIN 1399

#define AWB_CT_2800K_RGAIN 231
#define AWB_CT_2800K_BGAIN 1031

#define AWB_CT_3700K_RGAIN 284
#define AWB_CT_3700K_BGAIN 786

#define AWB_CT_4700K_RGAIN 343
#define AWB_CT_4700K_BGAIN 606

#define AWB_CT_6500K_RGAIN 405
#define AWB_CT_6500K_BGAIN 377

#define AWB_CT_11000K_RGAIN 512
#define AWB_CT_11000K_BGAIN 294
...
void awb_get_param_ar0237_rgbir_evb(UINT32* param);

void awb_get_param_ar0237_rgbir_evb(UINT32* param)
{
	*param =  (UINT32)(&awb_param_ar0237_rgbir_evb);
}
