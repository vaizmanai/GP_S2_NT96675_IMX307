...
/**
    CT gain
*/
#define AWB_CT_2300K_RGAIN 225
#define AWB_CT_2300K_BGAIN 497

#define AWB_CT_2800K_RGAIN 256
#define AWB_CT_2800K_BGAIN 452

#define AWB_CT_3700K_RGAIN 291
#define AWB_CT_3700K_BGAIN 412

#define AWB_CT_4700K_RGAIN 341
#define AWB_CT_4700K_BGAIN 367

#define AWB_CT_6500K_RGAIN 418
#define AWB_CT_6500K_BGAIN 293

#define AWB_CT_11000K_RGAIN 493
#define AWB_CT_11000K_BGAIN 259
...
void awb_get_param_sc4236_evb(UINT32* param);

void awb_get_param_sc4236_evb(UINT32* param)
{
	*param =  (UINT32)(&awb_param_sc4236_evb);
		//DBG_ERR("%x \r\n", *param);
}
