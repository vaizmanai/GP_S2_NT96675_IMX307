...
/**
    CT gain
*/
#define AWB_CT_2300K_RGAIN 245
#define AWB_CT_2300K_BGAIN 467

#define AWB_CT_2800K_RGAIN 275
#define AWB_CT_2800K_BGAIN 445

#define AWB_CT_3700K_RGAIN 333
#define AWB_CT_3700K_BGAIN 420

#define AWB_CT_4700K_RGAIN 383
#define AWB_CT_4700K_BGAIN 379

#define AWB_CT_6500K_RGAIN 417
#define AWB_CT_6500K_BGAIN 333

#define AWB_CT_11000K_RGAIN 518
...
void awb_get_param_jxk02_evb(UINT32* param);

void awb_get_param_jxk02_evb(UINT32* param)
{
	*param =  (UINT32)(&awb_param_jxk02_evb);
		//DBG_ERR("%x \r\n", *param);
}
