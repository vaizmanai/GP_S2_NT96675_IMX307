...
awb_param awb_param_imx290_evb = {
    &awb_param_ca_info,
    &awb_param_th,
...
void awb_get_param_imx290_evb(UINT32* param);

void awb_get_param_imx290_evb(UINT32* param)
{
	*param =  (UINT32)(&awb_param_imx290_evb);
}
