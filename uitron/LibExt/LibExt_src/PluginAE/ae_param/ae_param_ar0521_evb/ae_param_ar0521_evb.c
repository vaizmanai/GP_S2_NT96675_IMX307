...
#define AE_CAP_ISO_MAX          12800

static AE_EXPECT_LUM expect_lum = {
    475, // mov
    428, // photo
    {77,  77,    100, 100,  100,  100,  100,  100,   100,   100,   100,  100,   100,  100,  100,  100,  100,  100,  100,  100,  100}, // mov
...
AE_PARAM_INFO ae_param_ar0521_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_ar0521_evb(UINT32 *param);

void ae_get_param_ar0521_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_ar0521_evb;
}
