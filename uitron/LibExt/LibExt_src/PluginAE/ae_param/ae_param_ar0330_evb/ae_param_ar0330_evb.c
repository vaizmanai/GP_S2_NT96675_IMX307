...
#define AE_PRV_ISO_MAX          25600//12300
#define AE_CAP_ISO_MIN          AE_ISO_BASE
#define AE_CAP_ISO_MAX          25600//12300

static AE_EXPECT_LUM expect_lum = {
    480, // mov
    480, // photo
    {89, 93, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100 },
...
AE_PARAM_INFO ae_param_ar0330_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_ar0330_evb(UINT32 *param);

void ae_get_param_ar0330_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_ar0330_evb;
}
