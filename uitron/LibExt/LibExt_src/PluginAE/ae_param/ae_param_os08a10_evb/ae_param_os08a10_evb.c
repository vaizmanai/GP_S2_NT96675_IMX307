...
static AE_CURVE_GEN_PARAM curve_gen_param  = {
    ...
    {64, 512},
    DISABLE,
    {{2400, 2400}, {1000, 1000}, {500, 500}, {300, 300}, {240, 240}},
...
AE_PARAM_INFO ae_param_os08a10_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_os08a10_evb(UINT32 *param);

void ae_get_param_os08a10_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_os08a10_evb;
}
