...
static AE_EXPECT_LUM expect_lum = {
    480, // mov
    480, // photo
    {33,  33,  33,  33,  33,  33,  50,  70,   80,   90,   100,  100,   100,  100,  100,  100,  100,  100,  100,  100,  100}, // mov
...
AE_PARAM_INFO ae_param_sample_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_sample_evb(UINT32 *param);

void ae_get_param_sample_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_sample_evb;
}
