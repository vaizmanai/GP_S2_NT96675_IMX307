...
#define AE_ISP_GAIN_THRES       3200

static AE_EXPECT_LUM expect_lum = {
    480, // mov
    480, // photo
    {73, 74, 80, 90, 95, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100 },
    {100,  100,    100, 100,  100,  100,  100,  100,   100,   100,   100,  100,   100,  100,  100,  100,  100,  100,  100,  100,  100}, // photo
    {100,  100,    100, 100,  100,  100,  100,  100,   100,   100,   100,  100,   100,  100,  100,  100,  100,  100,  100,  100,  100}, // ir
};
...
AE_PARAM_INFO ae_param_ar0237_rgbir_evb = {
    AE_PRV_ISO_MIN,
    1000,
    &expect_lum,
    &la_clamp,
...
void ae_get_param_ar0237_rgbir_evb(UINT32 *param);

void ae_get_param_ar0237_rgbir_evb(UINT32 *param)
{
	*param = (UINT32) &ae_param_ar0237_rgbir_evb;
}
