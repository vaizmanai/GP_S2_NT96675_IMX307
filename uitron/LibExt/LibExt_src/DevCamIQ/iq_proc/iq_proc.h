...
extern IQS_SHDR_EVRATIO_TH *g_hdr_lv_th_addr[Total_SENIDNum];
extern SHDR_IQ_PARA *g_hdr_high_addr[Total_SENIDNum];
extern SHDR_IQ_PARA *g_hdr_middle_addr[Total_SENIDNum];
extern SHDR_IQ_PARA *g_hdr_low_addr[Total_SENIDNum];
extern IQS_PATHCURVE_LV_TH *g_pathcurve_lv_th_addr[Total_SENIDNum];
extern UINT32 *g_pathcurve_high_addr[Total_SENIDNum];
extern UINT32 *g_pathcurve_middle_addr[Total_SENIDNum];
extern UINT32 *g_pathcurve_low_addr[Total_SENIDNum];
...
extern UINT8 *g_rbfill_luma_tab_addr[Total_SENIDNum];
extern UINT8 *g_rbfill_ratio_tab_addr[Total_SENIDNum];
extern IFE_RBFILL *g_rbfill_addr[Total_SENIDNum];
...
extern UINT32 *g_ccon_tab_addr[Total_SENIDNum];
...
extern IME_HAL_TMNR_INFO **g_tmnr_info_addr[Total_SENIDNum];
extern UINT32 *g_tmnr_momap_sel_addr[Total_SENIDNum];
extern TMNR_AUTO_INFO *g_tmnr_auto_info_addr[Total_SENIDNum];
