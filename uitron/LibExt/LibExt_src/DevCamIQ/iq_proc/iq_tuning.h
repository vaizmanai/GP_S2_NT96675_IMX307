...
////////////////////////////////
//**  RHE-CGain
extern UINT32 g_rhe_ob_buf[Total_SENIDNum][5];
...
//**  RHE-HDR
extern SHDR_IQ_PARA g_hdr_buf[Total_SENIDNum];
extern UINT32 g_pathcurve_buf[Total_SENIDNum][33];
...
//**  IFE-Spatial
extern UINT32 g_spatial_w_buf[Total_SENIDNum][6];
...
//**  IFE-CGain
extern UINT32 g_ife_ob_buf[Total_SENIDNum][5];
extern UINT32 g_ife_c_gain_buf[Total_SENIDNum][5];
...
//**  IFE-RBFill
extern UINT8 g_rbfill_luma_tab_buf[Total_SENIDNum][17];
extern UINT8 g_rbfill_ratio_tab_buf[Total_SENIDNum][32];
extern IFE_RBFILL g_rbfill_buf[Total_SENIDNum];
...
extern UINT32 g_ccon_tab_buf[Total_SENIDNum][17];
...
//**  IME-TMNR
extern IME_HAL_TMNR_INFO g_tmnr_info_buf[Total_SENIDNum];
extern TMNR_AUTO_INFO g_tmnr_auto_info_buf[Total_SENIDNum];
