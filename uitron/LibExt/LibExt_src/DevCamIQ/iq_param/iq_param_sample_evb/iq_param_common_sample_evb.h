#ifndef _IQ_PARAM_COMMON_SAMPLE_EVB_H_
#define _IQ_PARAM_COMMON_SAMPLE_EVB_H_
...
extern IQS_SHDR_EVRATIO_TH hdr_lv_th_sample_evb;
extern SHDR_IQ_PARA hdr_high_sample_evb;
extern SHDR_IQ_PARA hdr_middle_sample_evb;
extern SHDR_IQ_PARA hdr_low_sample_evb;
extern IQS_PATHCURVE_LV_TH pathcurve_lv_th_sample_evb;
extern UINT32 pathcurve_high_sample_evb[33];
extern UINT32 pathcurve_middle_sample_evb[33];
extern UINT32 pathcurve_low_sample_evb[33];
extern S_DEFOG_LIB_INIT_PARA defog_init_param_sample_evb;
extern UINT32 defog_wet_sample_evb[17];
extern IME_TMNR_DISPMOMAP tmnr_momap_sel_sample_evb;
extern TMNR_AUTO_INFO tmnr_auto_info_sample_evb;

extern void iq_param_sample_evb_table1_init(UINT32 id,UINT32 mode_idx);
