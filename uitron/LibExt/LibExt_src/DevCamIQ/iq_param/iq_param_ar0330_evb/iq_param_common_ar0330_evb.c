#ifndef _IQ_PARAM_COMMON_AR0330_EVB_C
#define _IQ_PARAM_COMMON_AR0330_EVB_C

#include "iq_param_common_ar0330_evb.h"

ISOMAP iso_map_tab_ar0330_evb[IQS_ISOMAPTAB_NUM] =
{
    {  100, IQS_GAIN_1X},
    {  200, IQS_GAIN_2X},
    {  400, IQS_GAIN_4X},
...
S_DEFOG_LIB_INIT_PARA defog_init_param_ar0330_evb =
{
	{32,32, 40, 40, 50, 50, 64, 64, 64},
	255
};

UINT32 defog_wet_ar0330_evb[17] =
{
...
UINT32 ldc_g_lut_ar0330_evb[65] =
{
...
//**  IPE-CC
//////////////////////
IQS_COLOR_TEMPERATURE_TH color_temperature_th_ar0330_evb =
{
    //Low,  Middle, High
    2800,   3700,   6500
};

IQS_COLOR_TEMPERATURE_PARAM color_low_ar0330_evb =
{
    {//CCM A
    //100%
    0x0101, 0x0ff9, 0x0005,
    0x0f90, 0x0164, 0x000b,
    0x0fd3, 0x0f4f, 0x01df
    /*
    0x1A0,	0xF93,	0xFCD,
    0xF9B,	0x182,	0xFE3,
    0x064,	0xE81,	0x21C,
...
IQS_COLOR_TEMPERATURE_PARAM color_middle_ar0330_evb =
{
    {//CCM TL84
    0x0124, 0x0fdb, 0x0001,
    0x0f92, 0x0171, 0x0ffe,
    0x0fea, 0x0f61, 0x01b5
    /*
    0x1AB,	0xF7A,	0xFDB,
    0xF9E,	0x179,	0xFEA,
    0x03B,	0xEF4,	0x1D1,
...
IQS_COLOR_TEMPERATURE_PARAM color_high_ar0330_evb =
{
    {//CCM D65
    //100%
    0x0139, 0x0fef, 0x0fd8,
    0x0f8d, 0x0191, 0x0fe3,
    0x0ffc, 0x0f8c, 0x0179
    /*
    0x1BF,	0xF47,	0xFFA,
    0xF9C,	0x196,	0xFCE,
    0x00D,	0xEE3,	0x20F,
...
UINT8 fs_tab_ar0330_evb[TOTAL_GAIN_NUM][16] =
{
...
UINT8 fd_tab_ar0330_evb[TOTAL_GAIN_NUM][16] =
{
...
IPE_CC cc_ar0330_evb =
{
    CC_3_8, toIdentity, CC_PRE_GAMMA, CC_SEL_MAX, CC_OFS_BYPASS_SEL, (UINT32)color_high_ar0330_evb.IQS_CC, (UINT32)fs_tab_ar0330_evb, (UINT32)fd_tab_ar0330_evb
};

//////////////////////
//**  IPE-Ycurve
//////////////////////
UINT32 y_curve_ar0330_evb[129] = //linear
{
...
//**  IPE-Gamma
//////////////////////
IQS_GAMMA_LV_TH gamma_lv_th_ar0330_evb =
{
    //DAY,  NIGHT,
    600,    400
};

UINT32 gamma_day_ar0330_evb[129] =
{
...
UINT32 gamma_night_ar0330_evb[129] =
{
    0,27,52,77,101,124,146,168,189,209,
    228,247,266,283,301,318,334,350,365,380,
    395,409,423,436,449,462,474,487,498,510,
...
//**  IPE-CCtrl
//////////////////////
UINT8 edg_tab_ar0330_evb[24] =
{
    128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128
};

UINT8 dds_tab_ar0330_evb[8] =
{
...
//**  IPE-CST
//////////////////////
INT16 cst_coef_ar0330_evb[9] =
{
    77, 150, 29, -43, -85, 128, 128, -107, -21
};

IPE_CST cst_ar0330_evb =
{
    (UINT32)cst_coef_ar0330_evb, CST_SEL_MINUS128, 0
};

//////////////////////
//**  IPE-YCCFIX
//////////////////////
IPE_YCCFIX ycc_fix_ar0330_evb =
{
...
//**  IPE-NoiseParam
//////////////////////
IPE_RAND_NR noise_param_ar0330_evb =
{
...
//**  IPE-GammaRand
//////////////////////
 IPE_GamRand gamma_rand_ar0330_evb =
{
    FALSE, 0, 0
};
...
//////////////////////
UINT32 color_3d_lut_ar0330_evb[900] =
{
...
IPE_3DCCRound color_3d_ar0330_evb = {SEL_RANDOM, TRUE};

IME_TMNR_DISPMOMAP tmnr_momap_sel_ar0330_evb = IME_TMNR_DISPMOMAP_NONE;

IQS_SHDR_EVRATIO_TH hdr_lv_th_ar0330_evb =
{
    //High, Middle, Low,
    2048,	1024,	512
};

SHDR_IQ_PARA hdr_high_ar0330_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_middle_ar0330_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_low_ar0330_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
IQS_PATHCURVE_LV_TH pathcurve_lv_th_ar0330_evb =
{
    //High, Middle, Low,
    1400,   600,    400
};

UINT32 pathcurve_high_ar0330_evb[33] = 
{
...
UINT32 pathcurve_middle_ar0330_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
UINT32 pathcurve_low_ar0330_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
TMNR_AUTO_INFO tmnr_auto_info_ar0330_evb =
{
