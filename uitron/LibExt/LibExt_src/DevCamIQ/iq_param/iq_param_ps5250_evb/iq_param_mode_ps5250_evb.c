#ifndef _IQ_PARAM_MODE_PS5250_EVB_C
#define _IQ_PARAM_MODE_PS5250_EVB_C

#include "iq_param_common_ps5250_evb.h"

static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
	iq_param_ps5250_evb_table1_init, //IQS_PARAM_TABLE1
    NULL,
    NULL,
};
...
void iq_param_init_ps5250_evb(UINT32 Id);
