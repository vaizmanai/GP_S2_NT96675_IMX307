#ifndef _IQ_PARAM_MODE_IMX307_EVB_C
#define _IQ_PARAM_MODE_IMX307_EVB_C

#include "iq_param_common_imx307_evb.h"

static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
	iq_param_imx307_evb_table1_init, //IQS_PARAM_TABLE1
...
void iq_param_init_imx307_evb(UINT32 Id);
