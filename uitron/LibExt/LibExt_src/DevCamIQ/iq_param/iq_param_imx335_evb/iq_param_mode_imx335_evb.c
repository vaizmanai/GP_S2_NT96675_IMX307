#ifndef _IQ_PARAM_MODE_IMX335_EVB_C
#define _IQ_PARAM_MODE_IMX335_EVB_C
...
static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
	iq_param_imx335_evb_table1_init, //IQS_PARAM_TABLE1
...
void iq_param_init_imx335_evb(UINT32 Id);
void iq_param_init_imx335_evb(UINT32 Id)
{
