#ifndef _IQ_PARAM_MODE_SC5035_EVB_C
#define _IQ_PARAM_MODE_SC5035_EVB_C

#include "iq_param_common_sc5035_evb.h"

static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
    iq_param_sc5035_evb_table1_init, //IQS_PARAM_TABLE1
    NULL,
};
...
void iq_param_init_sc5035_evb(UINT32 Id);
    
void iq_param_init_sc5035_evb(UINT32 Id)
{
    UINT32 SenId_Value = Id; // Used before IPL start, error if =iq_get_sensor_idx(Id)
    UINT32 idx;
