#ifndef _IQ_PARAM_COMMON_JXK03_EVB_C
#define _IQ_PARAM_COMMON_JXK03_EVB_C

#include "iq_param_common_jxk03_evb.h"

ISOMAP iso_map_tab_jxk03_evb[IQS_ISOMAPTAB_NUM] =
{
    {  100, IQS_GAIN_1X},
    {  200, IQS_GAIN_2X},
    {  400, IQS_GAIN_4X},
...
S_DEFOG_LIB_INIT_PARA defog_init_param_jxk03_evb =
{
	{32,32, 40, 40, 50, 50, 64, 64, 64},
	255
};

UINT32 defog_wet_jxk03_evb[17] =
{
...
//**  IPE-CC
//////////////////////
IQS_COLOR_TEMPERATURE_TH color_temperature_th_jxk03_evb =
{
    //Low,  Middle, High
    2800,   3700,   6500
};

IQS_COLOR_TEMPERATURE_PARAM color_low_jxk03_evb =
{
    {//CCM A
    0x0139, 0x0f87, 0x0040,
    0x0f38, 0x01b3, 0x0015,
    0x0f1c, 0x0daf, 0x0435
    },
...
IQS_COLOR_TEMPERATURE_PARAM color_middle_jxk03_evb =
{
    {//CCM TL84
    0x01c4, 0x0f16, 0x0026,
    0x0f61, 0x01a3, 0x0ffc,
    0x0f8a, 0x0e5a, 0x031c
    },
    //hue table, Legal range : 0~255, 128 : NO sat adjust
    {128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
    //sat table, Legal range : -128~127, 0 : NO sat adjust
...
IQS_COLOR_TEMPERATURE_PARAM color_high_jxk03_evb =
{
    {//CCM D65
    0x0265, 0x0ea1, 0x0ffa,
    0x0f8d, 0x0224, 0x0f4f,
    0x0fd2, 0x0ed6, 0x0258
    },
    //hue table, Legal range : 0~255, 128 : NO sat adjust
    {128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
    //sat table, Legal range : -128~127, 0 : NO sat adjust
...
UINT8 fs_tab_jxk03_evb[TOTAL_GAIN_NUM][16] =
{
...
UINT8 fd_tab_jxk03_evb[TOTAL_GAIN_NUM][16] =
{
...
IPE_CC cc_jxk03_evb =
{
    CC_3_8, toIdentity, CC_PRE_GAMMA, CC_SEL_MAX, CC_OFS_BYPASS_SEL, (UINT32)color_high_jxk03_evb.IQS_CC, (UINT32)fs_tab_jxk03_evb, (UINT32)fd_tab_jxk03_evb
};

//////////////////////
//**  IPE-Ycurve
//////////////////////
UINT32 y_curve_jxk03_evb[129] = //linear
{
...
//**  IPE-Gamma
//////////////////////
IQS_GAMMA_LV_TH gamma_lv_th_jxk03_evb =
{
    //DAY,  NIGHT,
    600,    400
};

UINT32 gamma_day_jxk03_evb[129] =
{
...
UINT32 gamma_night_jxk03_evb[129] =
{
    0,37,73,107,139,169,198,225,241,257,
    273,289,304,318,333,347,360,373,386,399,
    411,422,433,444,455,465,475,484,493,502,
...
//**  IPE-CCtrl
//////////////////////
UINT8 edg_tab_jxk03_evb[24] =
{
    128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128
};

UINT8 dds_tab_jxk03_evb[8] =
{
...
//**  IPE-CST
//////////////////////
INT16 cst_coef_jxk03_evb[9] =
{
    77, 150, 29, -43, -85, 128, 128, -107, -21
};

IPE_CST cst_jxk03_evb =
{
    (UINT32)cst_coef_jxk03_evb, CST_SEL_MINUS128, 0
};

//////////////////////
//**  IPE-YCCFIX
//////////////////////
IPE_YCCFIX ycc_fix_jxk03_evb =
{
...
//**  IPE-NoiseParam
//////////////////////
IPE_RAND_NR noise_param_jxk03_evb =
{
...
//**  IPE-GammaRand
//////////////////////
 IPE_GamRand gamma_rand_jxk03_evb =
{
    FALSE, 0, 0
};
...
//////////////////////
UINT32 color_3d_lut_jxk03_evb[900] =
{
...
IPE_3DCCRound color_3d_jxk03_evb = {SEL_RANDOM, TRUE};

IME_TMNR_DISPMOMAP tmnr_momap_sel_jxk03_evb = IME_TMNR_DISPMOMAP_NONE;

IQS_SHDR_EVRATIO_TH hdr_lv_th_jxk03_evb =
{
    //High, Middle, Low,
    2048,	1024,	512
};

SHDR_IQ_PARA hdr_high_jxk03_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_middle_jxk03_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_low_jxk03_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
IQS_PATHCURVE_LV_TH pathcurve_lv_th_jxk03_evb =
{
    //High, Middle, Low,
    1400,   600,    400
};

UINT32 pathcurve_high_jxk03_evb[33] = 
{
...
UINT32 pathcurve_middle_jxk03_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
UINT32 pathcurve_low_jxk03_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
TMNR_AUTO_INFO tmnr_auto_info_jxk03_evb =
{
