#ifndef _IQ_PARAM_MODE_JXK03_EVB_C
#define _IQ_PARAM_MODE_JXK03_EVB_C

#include "iq_param_common_jxk03_evb.h"

static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
	iq_param_jxk03_evb_table1_init, //IQS_PARAM_TABLE1
...
void iq_param_init_jxk03_evb(UINT32 Id);
