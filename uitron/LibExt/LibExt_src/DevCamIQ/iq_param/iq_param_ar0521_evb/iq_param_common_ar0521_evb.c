#ifndef _IQ_PARAM_COMMON_AR0521_EVB_C
#define _IQ_PARAM_COMMON_AR0521_EVB_C

#include "iq_param_common_ar0521_evb.h"

ISOMAP iso_map_tab_ar0521_evb[IQS_ISOMAPTAB_NUM] =
{
    {  100, IQS_GAIN_1X},
    {  200, IQS_GAIN_2X},
    {  400, IQS_GAIN_4X},
...
S_DEFOG_LIB_INIT_PARA defog_init_param_ar0521_evb =
{
	{32,32, 40, 40, 50, 50, 64, 64, 64},
	255
};

UINT32 defog_wet_ar0521_evb[17] =
{
...
UINT32 ldc_g_lut_ar0521_evb[65] =
{
...
//**  IPE-CC
//////////////////////
IQS_COLOR_TEMPERATURE_TH color_temperature_th_ar0521_evb =
{
    //Low,  Middle, High
    2800, 4700, 6500
};

IQS_COLOR_TEMPERATURE_PARAM color_low_ar0521_evb =
{
    {//CCM
    0x021c, 0x0fe9, 0x0efc,
    0x0f4b, 0x0279, 0x0f3c,
    0x000e, 0x0d93, 0x035f
    },
...
IQS_COLOR_TEMPERATURE_PARAM color_middle_ar0521_evb =
{
    {//CCM
    0x0260, 0x0fa5, 0x0efb,
    0x0f1c, 0x029b, 0x0f49,
    0x0ffc, 0x0e90, 0x0274
    },
    //hue table, Legal range : 0~255, 128 : NO sat adjust
    {128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
    //sat table, Legal range : -128~127, 0 : NO sat adjust
...
IQS_COLOR_TEMPERATURE_PARAM color_high_ar0521_evb =
{
    {//CCM
    0x02f7, 0x0f44, 0x0ec6,
    0x0f45, 0x02df, 0x0edd,
    0x0002, 0x0ee5, 0x0219
    },
    //hue table, Legal range : 0~255, 128 : NO sat adjust
    {128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128},
    //sat table, Legal range : -128~127, 0 : NO sat adjust
...
UINT8 fs_tab_ar0521_evb[TOTAL_GAIN_NUM][16] =
{
...
UINT8 fd_tab_ar0521_evb[TOTAL_GAIN_NUM][16] =
{
...
IPE_CC cc_ar0521_evb =
{
    CC_3_8, toIdentity, CC_PRE_GAMMA, CC_SEL_MAX, CC_OFS_BYPASS_SEL, (UINT32)color_high_ar0521_evb.IQS_CC, (UINT32)fs_tab_ar0521_evb, (UINT32)fd_tab_ar0521_evb
};

//////////////////////
//**  IPE-Ycurve
//////////////////////
UINT32 y_curve_ar0521_evb[129] = //linear
{
...
//**  IPE-Gamma
//////////////////////
IQS_GAMMA_LV_TH gamma_lv_th_ar0521_evb =
{
    //DAY,  NIGHT,
    600,    400
};

UINT32 gamma_day_ar0521_evb[129] =
{
...
UINT32 gamma_night_ar0521_evb[129] =
{
    0,37,73,107,139,169,198,225,241,257,
    273,289,304,318,333,347,360,373,386,399,
    411,422,433,444,455,465,475,484,493,502,
...
//**  IPE-CCtrl
//////////////////////
UINT8 edg_tab_ar0521_evb[24] =
{
    128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128
};

UINT8 dds_tab_ar0521_evb[8] =
{
...
//**  IPE-CST
//////////////////////
INT16 cst_coef_ar0521_evb[9] =
{
    77, 150, 29, -43, -85, 128, 128, -107, -21
};

IPE_CST cst_ar0521_evb =
{
    (UINT32)cst_coef_ar0521_evb, CST_SEL_MINUS128, 0
};

//////////////////////
//**  IPE-YCCFIX
//////////////////////
IPE_YCCFIX ycc_fix_ar0521_evb =
{
...
//**  IPE-NoiseParam
//////////////////////
IPE_RAND_NR noise_param_ar0521_evb =
{
...
//**  IPE-GammaRand
//////////////////////
 IPE_GamRand gamma_rand_ar0521_evb =
{
    FALSE, 0, 0
};
...
//////////////////////
UINT32 color_3d_lut_ar0521_evb[900] =
{
...
IPE_3DCCRound color_3d_ar0521_evb = {SEL_RANDOM, TRUE};

IME_TMNR_DISPMOMAP tmnr_momap_sel_ar0521_evb = IME_TMNR_DISPMOMAP_NONE;

IQS_SHDR_EVRATIO_TH hdr_lv_th_ar0521_evb =
{
    //High, Middle, Low,
    2048,	1024,	512
};

SHDR_IQ_PARA hdr_high_ar0521_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_middle_ar0521_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
SHDR_IQ_PARA hdr_low_ar0521_evb =
{
    {0, 16, 32, 144, 255, 0, 64, 255, 64, 0},
    128, // uiRefMapWeight 0~255
    16, // Bright Contrast Enance level 0~32
...
IQS_PATHCURVE_LV_TH pathcurve_lv_th_ar0521_evb =
{
    //High, Middle, Low,
    1400,   600,    400
};

UINT32 pathcurve_high_ar0521_evb[33] = 
{
...
UINT32 pathcurve_middle_ar0521_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
UINT32 pathcurve_low_ar0521_evb[33] = 
{
	0x000, 0x080, 0x100, 0x180, 0x200, 0x280, 0x300, 0x380, 0x400, 0x480,
	0x500, 0x580, 0x600, 0x680, 0x700, 0x780, 0x800, 0x880, 0x900, 0x980,
	0xA00, 0xA80, 0xB00, 0xB80, 0xC00, 0xC80, 0xD00, 0xD80, 0xE00, 0xE80,
...
TMNR_AUTO_INFO tmnr_auto_info_ar0521_evb =
{
