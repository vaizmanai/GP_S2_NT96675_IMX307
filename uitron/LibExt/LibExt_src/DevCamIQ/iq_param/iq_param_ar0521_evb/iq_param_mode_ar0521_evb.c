#ifndef _IQ_PARAM_MODE_AR0521_EVB_C
#define _IQ_PARAM_MODE_AR0521_EVB_C

#include "iq_param_common_ar0521_evb.h"

static SENSOR_MODE_PARAM mode_table[IQS_PARAM_TABLE_MAX]= {
    NULL,
    iq_param_ar0521_evb_table1_init, //IQS_PARAM_TABLE1
    NULL,
    NULL,
};
...
void iq_param_init_ar0521_evb(UINT32 Id);
