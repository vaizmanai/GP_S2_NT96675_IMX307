...
#ifndef __NA51023_MMC_H__
#define __NA51023_MMC_H__

#include "na51023_mmcreg.h"
...
#define PAD_DS_CGPIO12         ((PAD_DS_CGPIO_BASE + 12) | PAD_DS_GROUP5_40)
#define PAD_DS_CGPIO13         ((PAD_DS_CGPIO_BASE + 13) | PAD_DS_GROUP5_40)
#define PAD_DS_CGPIO14         ((PAD_DS_CGPIO_BASE + 14) | PAD_DS_GROUP5_40)
#define PAD_DS_CGPIO15         ((PAD_DS_CGPIO_BASE + 15) | PAD_DS_GROUP5_40)
...
#define PAD_DS_CGPIO24         (PAD_DS_CGPIO_BASE + 24)
...
#define SDIO_DLY_DATA_PHASE_SFT	28
...
#define SDIO_DLY_DDR_START_SAMPLE_SFT	27
#define SDIO_DLY_DDR_START_NEG	(0<<SDIO_DLY_DDR_START_SAMPLE_SFT)
#define SDIO_DLY_DDR_START_POS	(1<<SDIO_DLY_DDR_START_SAMPLE_SFT)
#define SDIO_DLY_DDR_DATA_SWAP_SFT	26
#define SDIO_DLY_DDR_DATA_NON_SWAP	(0<<SDIO_DLY_DDR_DATA_SWAP_SFT)
#define SDIO_DLY_DDR_DATA_SWAP	(1<<SDIO_DLY_DDR_DATA_SWAP_SFT)
#define SDIO_OUTDLY_EN_SFT	4
#define SDIO_OUTDLY_DIS	0
#define SDIO_OUTDLY_EN	1
#define SDIO_OUTDLY_SEL_SFT	8

#define SDIO_DLY_DS_DEFAULT             (SDIO_DLY_SAMPEDGE_DATA_POS)+(2<<SDIO_DLY_PHASE_UNIT_SFT) + (0<<SDIO_DLY_CMD_PHASE_SFT) + (0<<SDIO_DLY_DATA_PHASE_SFT) + (0<<SDIO_DLY_DATA_SFT) + (1<<SDIO_DLY_CLK_SRC)
#define SDIO_DLY_HS_DEFAULT             (SDIO_DLY_SAMPEDGE_DATA_POS)+(2<<SDIO_DLY_PHASE_UNIT_SFT) + (0<<SDIO_DLY_CMD_PHASE_SFT) + (0<<SDIO_DLY_DATA_PHASE_SFT) + (0<<SDIO_DLY_DATA_SFT) + (1<<SDIO_DLY_CLK_SRC)
#define SDIO_DLY_SDR50_DEFAULT      	(SDIO_DLY_SAMPEDGE_DATA_POS)+(2<<SDIO_DLY_PHASE_UNIT_SFT) + (3<<SDIO_DLY_CMD_PHASE_SFT) + (3<<SDIO_DLY_DATA_PHASE_SFT) + (0<<SDIO_DLY_DATA_SFT) + (1<<SDIO_DLY_CLK_SRC)
#define SDIO_DLY_SDR104_DEFAULT		0x2020
