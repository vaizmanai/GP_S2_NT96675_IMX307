...
{
	if ((pin < C_GPIO(0)) || (pin > C_GPIO(23) && pin < P_GPIO(0)) || \
	(pin > P_GPIO(27) && pin < S_GPIO(0)) || \
	(pin > S_GPIO(14) && pin < L_GPIO(0)) || \
	(pin > L_GPIO(23) && pin < D_GPIO(0)) || \
	(pin > D_GPIO(7) && pin < H_GPIO(0)) || (pin > H_GPIO(11))) {
