...
const struct nand_flash_dev nvt_nand_ids[] = {
	...
	{"SPI-NAND 128MiB 1.8V",	0xBA, 2048, 128, 0x20000,   	NAND_NO_SUBPAGE_WRITE},
	{"SPI-NAND 512MiB 1.8V",	0xC4, 4096, 512, 0x80000,   	NAND_NO_SUBPAGE_WRITE},
	...
	{"SPI-NAND 128MiB 3V ",		0xD2, 2048, 256, 0x20000,   	NAND_NO_SUBPAGE_WRITE},
};

const struct nand_manufacturers nvt_nand_manuf_ids[] = {
	{NAND_MFR_TOSHIBA, "Toshiba"},
	{NAND_MFR_SAMSUNG, "Samsung"},
	{NAND_MFR_FUJITSU, "Fujitsu"},
	{NAND_MFR_NATIONAL, "National"},
