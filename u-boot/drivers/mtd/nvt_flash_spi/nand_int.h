...
#define  DUMP_SPARE             0
#include "nvt_type.h"
#define dma_getPhyAddr(addr) 	((((uint32_t)(addr))>=0x40000000UL)?((uint32_t)(addr)-0x40000000UL):(uint32_t)(addr))

#define CPU1_BOOT_MASK 0x1
#define CPU2_BOOT_MASK 0x2
...
#define FLASH_CMD_DUAL_READ_4BYTE       0x3C            //FLASH CMD DUAL READ with 4Byte address
...
//#define SPINAND_CMD_CACHE_READ    (0x0B)
