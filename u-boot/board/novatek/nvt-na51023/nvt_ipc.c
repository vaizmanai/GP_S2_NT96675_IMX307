...
#define loc_multiCores()    {cc_hwLockResource(CC_CORE_MIPS2,CC_RESOURCE_IPC);}
#define unl_multiCores()    {cc_hwUnlockResource(CC_CORE_MIPS2,CC_RESOURCE_IPC);}
