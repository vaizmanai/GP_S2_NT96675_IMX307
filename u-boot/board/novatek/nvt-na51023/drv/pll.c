...
#define loc_multiCores()    {loc_cpu();cc_hwLockResource(CC_CORE_MIPS2,CC_RESOURCE_CKG);}
#define unl_multiCores()    {cc_hwUnlockResource(CC_CORE_MIPS2,CC_RESOURCE_CKG);unl_cpu();}
