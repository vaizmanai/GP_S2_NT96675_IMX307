...
/*
 * Rename file "oldname" to "newname" from the partition previously set by
 * fs_set_blk_dev().
 *
 * Returns 0 on success. Returns non-zero on error.
 */
...
/*
 * Remove file "filename" from the partition previously set by fs_set_blk_dev().
 *
 * Returns 0 on success. Returns non-zero on error.
 */
...
int do_rm(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[],
		int fstype);
int do_rename(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[],
		int fstype);
