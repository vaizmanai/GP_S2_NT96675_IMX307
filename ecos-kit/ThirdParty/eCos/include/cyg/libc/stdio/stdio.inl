...
/* This macro is only to be used with recent G++, and avoids inline
 * function definition clashes due to not being in the correct namespace
 */
#if defined(__cplusplus) && ((__GNUC__ > 3) || ((__GNUC__ == 3) && (__GNUC_MINOR__ >= 3)))
#define __CYG_LIBC_STDIO_CXX_STD_(_x_) std:: _x_
#else
#define __CYG_LIBC_STDIO_CXX_STD_(_x_) _x_
#endif
...
perror( const char *s ) __THROW
{
    if (s && *s)
    	...
    	// Check 2 version of eCos, write code like this, bypass
