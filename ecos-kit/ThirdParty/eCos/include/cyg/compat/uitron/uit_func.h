...
ER      kset_mpf(cyg_uint32 uiStart, cyg_uint32 uiEnd);
ER      kini_stk(cyg_uint32 uiAddr);
...
// - Novatek Functions
//cyg_uint32 NvtMem_GetNonCacheAddr(cyg_uint32 addr);
//cyg_uint32 NvtMem_GetPhyAddr(cyg_uint32 addr);
