...
typedef enum _NVTIPC_SENDTO {
	NVTIPC_SENDTO_CORE1 = 1,                 ///< MIPS core1
	NVTIPC_SENDTO_CORE2 = 2,                 ///< MIPS core2
...
typedef enum _NVTIPC_SENDER {
	NVTIPC_SENDER_CORE1 = 1,                 ///< MIPS core1
	NVTIPC_SENDER_CORE2 = 2,                 ///< MIPS core2
...
#define NVTIPC_SEMID_CRYPTO NVTIPC_SEM_ID_1 ///< Crypto semaphore id between multi-cpu
...
*/
extern NVTIPC_U32       NvtIPC_GetNonCacheAddr(NVTIPC_U32 addr);
...
extern NVTIPC_U32       NvtIPC_GetCacheAddr(NVTIPC_U32 addr);
...
*/
extern NVTIPC_U32       NvtIPC_GetPhyAddr(NVTIPC_U32 addr);
...
*/
extern NVTIPC_I32 NvtIPC_FlushCache(NVTIPC_U32 addr, NVTIPC_U32 size);
